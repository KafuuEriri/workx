...
def test_run_watch_keeps_polling_open_ready_to_merge_pr(monkeypatch):
    ...
    monkeypatch.setattr(
        gh_pr_watch,
        "collect_snapshot",
        lambda args: (snapshot, Path("/tmp/workx-babysit-pr-state.json")),
    )
    monkeypatch.setattr(
        gh_pr_watch,
        "print_event",
        ...
        99: [
            {
                ...
                "status": "completed",
                "conclusion": "failure",
                "html_url": "https://github.com/RonanXiao/workx/actions/runs/99/job/555",
            },
            {
                "id": 556,
                "name": "lint",
    ...
    assert failed_jobs == [
        {
            ...
            "conclusion": "failure",
            "html_url": "https://github.com/RonanXiao/workx/actions/runs/99/job/555",
            "logs_endpoint": "repos/RonanXiao/workx/actions/jobs/555/logs",
        }
    ]

    ...
    >
      ...
      >
        <div className="flex items-center">
          ...
          <IconButton size="sm" aria-label="Close" className="ml-auto" onClick={onClose}>
        ...
        <p className="mt-4 text-[13px] text-fg-secondary">Source folders</p>
        ...
        <div className="mt-2 overflow-hidden rounded-xl border border-line">
          ...
          >
            ...
            <span>{roots.length === 0 ? 'Add folders Workx can read and edit' : 'Add folder'}</span>
          </button>
        </div>

...
Thank you for helping us keep Workx secure!
...
## How to operate WORKX safely

For details on Workx security boundaries, including sandboxing, approvals, and network controls, see [Agent approvals & security](https://developers.openai.com/codex/agent-approvals-security).

...
platform(
    ...
    exec_properties = {{
        ...
        # Verify at https://hub.docker.com/layers/mbolin491/workx-bazel/latest/images/sha256:{image_sha}
        "container-image": "docker://docker.io/mbolin491/workx-bazel@sha256:{image_sha}",
        "Arch": "{arch}",
        "OSFamily": "Linux",
    }},

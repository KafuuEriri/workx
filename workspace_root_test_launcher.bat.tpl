...
if defined WORKX_BAZEL_TEST_SKIP_FILTERS (
...
powershell.exe -NoProfile -ExecutionPolicy Bypass -Command ^
  ...
  "$skipFilters = @();" ^
  "if (-not [string]::IsNullOrEmpty($env:WORKX_BAZEL_TEST_SKIP_FILTERS)) { $skipFilters = @($env:WORKX_BAZEL_TEST_SKIP_FILTERS -split ',' | Where-Object { $_ -ne '' }) };" ^

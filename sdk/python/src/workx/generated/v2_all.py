...
#   filename:  workx_app_server_protocol.v2.schemas.json
...
class WorkxAppServerProtocolV2(BaseModel):
    pass
...
class AmazonBedrockAccount(BaseModel):
    ...
    uses_workx_managed_credentials: Annotated[
        bool | None, Field(alias="usesWorkxManagedCredentials")
    ] = False
...
class WorkxErrorInfoValue(Enum):
...
class HttpConnectionFailedWorkxErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class ResponseStreamConnectionFailedWorkxErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class ResponseStreamDisconnectedWorkxErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class ResponseTooManyFailedAttemptsWorkxErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class WorkxResponseHandoffMode(Enum):
    thinking = "thinking"
...
class ProjectConfigLayerSource(BaseModel):
    ...
    dot_workx_folder: Annotated[AbsolutePathBuf, Field(alias="dotWorkxFolder")]
...
class ChatgptAuthTokensLoginAccountParams(BaseModel):
    ...
    chatgpt_plan_type: Annotated[
        ...
        Field(
            ...
            description="Optional plan type supplied by the client.\n\nWhen `null`, Workx attempts to derive the plan type from access-token claims. If unavailable, the plan defaults to `unknown`.",
        ),
    ] = None
    type: Annotated[
...
class RateLimitResetType(Enum):
    codex_rate_limits = "workxRateLimits"
    unknown = "unknown"
...
class ThreadApproveGuardianDeniedActionParams(BaseModel):
    ...
    event: Annotated[
        Any, Field(description="Serialized `workx_protocol::protocol::GuardianAssessmentEvent`.")
    ]
    thread_id: Annotated[str, Field(alias="threadId")]
...
class ActiveTurnNotSteerableWorkxErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class WorkxErrorInfo(
    RootModel[
        WorkxErrorInfoValue
        | HttpConnectionFailedWorkxErrorInfo
        | ResponseStreamConnectionFailedWorkxErrorInfo
        | ResponseStreamDisconnectedWorkxErrorInfo
        | ResponseTooManyFailedAttemptsWorkxErrorInfo
        | ActiveTurnNotSteerableWorkxErrorInfo
    ]
):
    model_config = ConfigDict(
        populate_by_name=True,
...
class ChatgptLoginAccountParams(BaseModel):
    ...
    codex_streamlined_login: Annotated[bool | None, Field(alias="workxStreamlinedLogin")] = None
...
class WebSearchThreadItem(BaseModel):
    ...
    results: Annotated[
        list | None,
        Field(
            description="Structured search results returned out-of-band by standalone web search.\n\nThese stay as opaque JSON at the extension/app-server boundary so new result fields and result types can pass through without a Workx release."
        ),
    ] = None
...
class TurnError(BaseModel):
    ...
    workx_error_info: Annotated[WorkxErrorInfo | None, Field(alias="workxErrorInfo")] = None
    message: str
...
class GetAccountRateLimitsResponse(BaseModel):
    ...
    rate_limits_by_limit_id: Annotated[
        ...
        Field(
            ...
            description="Multi-bucket view keyed by metered `limit_id` (for example, `workx`).",
        ),
    ] = None
...
class Turn(BaseModel):
    ...
    id: Annotated[
        str, Field(description="Identifier for this turn. Workx-generated turn IDs are UUIDv7.")
    ]
    items: Annotated[
...
class Thread(BaseModel):
    ...
    id: Annotated[
        str, Field(description="Identifier for this thread. Workx-generated thread IDs are UUIDv7.")
    ]
    ...
    source: Annotated[
        SessionSource,
        Field(
            description="Origin of the thread (CLI, VSCode, workx exec, workx app-server, etc.)."
        ),
    ]

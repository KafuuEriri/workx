...
RUN_REAL_WORKX_TESTS = os.environ.get("RUN_REAL_WORKX_TESTS") == "1"
pytestmark = pytest.mark.skipif(
    not RUN_REAL_WORKX_TESTS,
    reason="set RUN_REAL_WORKX_TESTS=1 to run real Workx integration coverage",
)
...
def runtime_env(tmp_path_factory: pytest.TempPathFactory) -> PreparedRuntimeEnv:
    ...
    env["WORKX_PYTHON_SDK_DIR"] = str(ROOT)

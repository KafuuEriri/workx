...
GENERATED_TARGETS = [
    Path("src/workx/generated/notification_registry.py"),
    Path("src/workx/generated/v2_all.py"),
    Path("src/workx/api.py"),
]
...
def test_generated_files_are_up_to_date():
    ...
    assert importlib.metadata.version("workx-cli-bin") == "0.147.0"
    env = os.environ.copy()
    env.pop("WORKX_EXEC_PATH", None)

...
def runtime_config():
    """Return an example-friendly WorkxConfig for repo-source SDK usage."""
...
def temporary_sample_image_path() -> Iterator[Path]:
    with tempfile.TemporaryDirectory(prefix="workx-python-example-image-") as temp_root:

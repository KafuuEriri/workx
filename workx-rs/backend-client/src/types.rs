pub use workx_backend_openapi_models::models::ConfigBundleResponse;
pub use workx_backend_openapi_models::models::CreditStatusDetails;
pub use workx_backend_openapi_models::models::DeliveredConfigToml;
pub use workx_backend_openapi_models::models::DeliveredManagedLayers;
pub use workx_backend_openapi_models::models::DeliveredRequirementsToml;
pub use workx_backend_openapi_models::models::DeliveredTomlFragment;
pub use workx_backend_openapi_models::models::PaginatedListTaskListItem;
pub use workx_backend_openapi_models::models::PlanType;
pub use workx_backend_openapi_models::models::RateLimitReachedKind;
pub use workx_backend_openapi_models::models::RateLimitStatusDetails;
pub use workx_backend_openapi_models::models::RateLimitStatusPayload;
pub use workx_backend_openapi_models::models::RateLimitWindowSnapshot;
pub use workx_backend_openapi_models::models::SpendControlLimitDetails;
pub use workx_backend_openapi_models::models::TaskListItem;
...
#[derive(Clone, Debug, Deserialize, PartialEq, Eq)]
pub struct WorkxWorkspaceMessagesResponse {
    #[serde(default)]
    pub messages: Vec<WorkxWorkspaceMessage>,
}

/// Authenticated Workx user settings used by CLI runtime policy.
#[derive(Clone, Copy, Debug, Default, Deserialize, PartialEq, Eq)]
pub struct WorkxUserSettingsResponse {
...
#[derive(Clone, Debug, Deserialize, PartialEq, Eq)]
pub struct WorkxWorkspaceMessage {
    pub message_id: String,
    pub message_type: WorkxWorkspaceMessageType,
...
#[derive(Clone, Copy, Debug, Deserialize, PartialEq, Eq)]
#[serde(rename_all = "snake_case")]
pub enum WorkxWorkspaceMessageType {
    Headline,
    Announcement,
    #[serde(other)]
    Unknown,
...
Second line"
    ...
    fn workspace_messages_response_deserializes_messages() {
        let response: WorkxWorkspaceMessagesResponse = serde_json::from_value(serde_json::json!({
            "messages": [
                {
        ...
        assert_eq!(
            response,
            WorkxWorkspaceMessagesResponse {
                messages: vec![
                    WorkxWorkspaceMessage {
                        message_id: "headline-id".to_string(),
                        message_type: WorkxWorkspaceMessageType::Headline,
                    ...
                    WorkxWorkspaceMessage {
                        ...
                        message_type: WorkxWorkspaceMessageType::Announcement,
                    ...
                    WorkxWorkspaceMessage {
                        ...
                        message_type: WorkxWorkspaceMessageType::Unknown,

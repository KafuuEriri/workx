//! Shared model metadata types exchanged between Workx services and clients.
//!
...
/// Metadata describing a Workx-supported model.
#[derive(Debug, Clone, Deserialize, Serialize, TS, JsonSchema, PartialEq)]
...
/// Model metadata returned by the Workx backend `/models` endpoint.

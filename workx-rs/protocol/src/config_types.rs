...
/// Limit for the text included in `workx.tool_result` log records.
...
/// Validated plain profile-v2 name used to select `$WORKX_HOME/<name>.config.toml`.
...
/// Collaboration mode for a Workx session.

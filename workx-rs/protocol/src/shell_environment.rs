...
pub const WORKX_SESSION_ID_ENV_VAR: &str = "WORKX_SESSION_ID";
pub const WORKX_THREAD_ID_ENV_VAR: &str = "WORKX_THREAD_ID";
pub const WORKX_EXEC_SERVER_NOISE_AUTH_TOKEN_ENV_VAR: &str = "WORKX_EXEC_SERVER_NOISE_AUTH_TOKEN";
...
///
/// This prevents accidental propagation of Workx launch context; it is not a
    ...
    I: IntoIterator<Item = (String, String)>,
{
    ...
    if let Some(thread_id) = thread_id {
        env_map.insert(WORKX_THREAD_ID_ENV_VAR.to_string(), thread_id.to_string());
    }
...
mod windows_tests {
    ...
    fn core_inherit_preserves_windows_startup_vars_case_insensitively() {
        let vars = make_vars(&[
            ...
            ("WinDir", "C:\\Windows"),
            ("AppData", "C:\\Users\\workx\\AppData\\Roaming"),
        ...
        let expected = HashMap::from([
            ...
            (
                "AppData".to_string(),
                "C:\\Users\\workx\\AppData\\Roaming".to_string(),
            ),
...
mod non_windows_tests {
    ...
    fn core_inherit_preserves_non_windows_core_vars_case_insensitively() {
        ...
        let expected = HashMap::from([
            ...
            ("home".to_string(), "/home/workx".to_string()),

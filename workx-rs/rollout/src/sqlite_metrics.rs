...
use workx_otel::ORIGINATOR_TAG;
use workx_otel::bounded_originator_tag_value;
use workx_state::DbTelemetry;
use workx_state::DbTelemetryHandle;
use workx_state::LOG_WRITE_BYTES_METRIC;
use workx_state::LOG_WRITE_MAX_ENTRY_BYTES_METRIC;
...
pub(crate) fn recorder(metrics: workx_otel::MetricsClient, originator: &str) -> DbTelemetryHandle {

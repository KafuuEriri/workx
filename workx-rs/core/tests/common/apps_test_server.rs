use crate::test_workx::TestWorkxBuilder;
use crate::test_workx::test_workx;
use anyhow::Result;
...
const WORKX_APPS_META_KEY: &str = "_workx_apps";
const WORKX_APPS_MCP_PATH_REGEX: &str = "^/api/codex/ps/mcp/?$";
const HOSTED_PLUGIN_RUNTIME_MCP_PATH_REGEX: &str = "^/api/codex/ps/mcp/?$";
const PROTOCOL_VERSION: &str = "2025-11-25";
const SERVER_NAME: &str = "workx-apps-test";
...
pub const DIRECT_CALENDAR_CREATE_EVENT_TOOL: &str = "mcp__workx_apps__calendar__create_event";
pub const DIRECT_CALENDAR_APP_ONLY_TOOL: &str = "mcp__workx_apps__calendar__app_only_action";
pub const DIRECT_CALENDAR_LIST_EVENTS_TOOL: &str = "mcp__workx_apps__calendar__list_events";
pub const DIRECT_CALENDAR_EXTRACT_TEXT_TOOL: &str = "mcp__workx_apps__calendar__extract_text";
pub const SEARCH_CALENDAR_NAMESPACE: &str = "mcp__workx_apps__calendar";
...
pub fn apps_enabled_builder(apps_base_url: impl Into<String>) -> TestWorkxBuilder {
...
pub fn search_capable_apps_builder(apps_base_url: impl Into<String>) -> TestWorkxBuilder {
    let apps_base_url = apps_base_url.into();
    test_workx()
        .with_auth(WorkxAuth::create_dummy_chatgpt_auth_for_testing())
...
async fn mount_streamable_http_json_rpc_with_startup_control(
    ...
    Mock::given(method("POST"))
        ...
        .respond_with(WorkxAppsJsonRpcResponder {
            connector_name,
            connector_description,
            searchable,
            include_app_only_tool,
...
struct WorkxAppsJsonRpcResponder {
    connector_name: String,
    connector_description: String,
    searchable: bool,
    include_app_only_tool: bool,
...
impl Respond for WorkxAppsJsonRpcResponder {
        ...
        match method {
            ...
            "tools/call" => {
                ...
                let file_id = body
                    ...
                    .and_then(Value::as_str)
                    .unwrap_or_default();
                let workx_apps_meta = body.pointer("/params/_meta/_workx_apps").cloned();

...
use workx_protocol::openai_models::CollaborationModeMessages;
use workx_protocol::openai_models::ModelMessages;
use workx_protocol::openai_models::ModelsResponse;
use workx_protocol::protocol::COLLABORATION_MODE_CLOSE_TAG;
...
fn model_with_collaboration_messages(
    ...
    default: Option<&str>,
    plan: Option<&str>,
) -> workx_protocol::openai_models::ModelInfo {
            ...
            .with_thread_settings(ThreadSettingsOverrides {
                ...
                summary: Some(
                    test.config
                        ...
                        .unwrap_or(workx_protocol::config_types::ReasoningSummary::Auto),
                ),
                collaboration_mode: Some(collaboration_mode),
                ..Default::default()
            }),
...
async fn cold_resume_refreshes_legacy_collaboration_snapshot_once(
    ...
    let builder_with_instructions = |instructions: &str| {
        ...
        test_workx().with_model(MODEL).with_config(move |config| {
            config.model_catalog = Some(ModelsResponse {
                models: vec![model],
            });
        })

...
// It allows the test binary to behave like workx and dispatch to apply_patch and workx-linux-sandbox
// based on the arg0.
// NOTE: this doesn't work on ARM
#[ctor]
pub static WORKX_ALIASES_TEMP_DIR: Option<TestBinaryDispatchGuard> = {
    configure_test_binary_dispatch("workx-core-tests", |exe_name, argv1| {
        if argv1 == Some(WORKX_CORE_APPLY_PATCH_ARG1) {

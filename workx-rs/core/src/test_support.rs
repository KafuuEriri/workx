...
use workx_models_manager::collaboration_mode_presets;
...
pub fn auth_manager_from_auth(auth: WorkxAuth) -> Arc<AuthManager> {
    AuthManager::from_auth_for_testing(auth)
}

pub fn auth_manager_from_auth_with_home(auth: WorkxAuth, workx_home: PathBuf) -> Arc<AuthManager> {
    AuthManager::from_auth_for_testing_with_home(auth, workx_home)
}
...
) -> workx_protocol::error::Result<crate::NewThread> {
    thread_manager
...
pub fn models_manager_with_provider(
    ...
    provider.models_manager(workx_home, /*config_model_catalog*/ None)
}
...
#[derive(Clone, Copy)]
pub enum TestWorkxResponsesRequestKind {
    Turn,
    Prewarm,
    WebsocketConnection,
}
...
pub fn responses_metadata(
    ...
    let request_kind = match request_kind {
        TestWorkxResponsesRequestKind::Turn => Some(WorkxResponsesRequestKind::Turn),
        TestWorkxResponsesRequestKind::Prewarm => Some(WorkxResponsesRequestKind::Prewarm),
        TestWorkxResponsesRequestKind::WebsocketConnection => None,
    };
    WorkxResponsesMetadata {
...
pub fn with_parent_turn(mut metadata: WorkxResponsesMetadata, id: &str) -> WorkxResponsesMetadata {

...
use workx_exec_server::ProcessSignal as ExecServerProcessSignal;
use workx_exec_server::ReadResponse as ExecReadResponse;
...
use workx_utils_pty::SpawnedPty;
...
impl UnifiedExecProcess {
    ...
    pub(super) async fn from_spawned(
        ...
        let output_rx = workx_utils_pty::combine_output_receivers(stdout_rx, stderr_rx);

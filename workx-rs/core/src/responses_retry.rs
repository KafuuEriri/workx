...
use tracing::warn;
use workx_client::RetryOperation;
...
pub(crate) async fn handle_retryable_response_stream_error(
    ...
    if turn_context
        ...
        && matches!(err.details(), WorkxErrorDetails::ConnectionFailed(_))
        ...
        && !turn_context.provider.info().is_amazon_bedrock()
    {
        ...
        workx_client::record_retry!(retry_state.connection_retries, retry_delay, operation);
    ...
    if retry_state.retries < max_retries {
        ...
        workx_client::record_retry!(retry_count, delay, operation);

...
use workx_prompts::render_review_exit_interrupted;
use workx_prompts::render_review_exit_success;
...
use workx_protocol::review_format::format_review_findings_block;
...
use crate::workx_delegate::run_workx_thread_one_shot;
...
impl SessionTask for ReviewTask {
    ...
    async fn run(
        ...
        session
            .services
            .session_telemetry
            .counter("workx.task.review", /*inc*/ 1, &[]);
        ...
        // Start sub-workx conversation and get the receiver for events.

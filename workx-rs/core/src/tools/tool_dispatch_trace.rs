...
//!
//! `workx-rollout-trace` owns the event schema and writer behavior. This module
...
use workx_rollout_trace::ToolDispatchInvocation;
use workx_rollout_trace::ToolDispatchPayload;
use workx_rollout_trace::ToolDispatchRequester;
use workx_rollout_trace::ToolDispatchResult;
use workx_rollout_trace::ToolDispatchTraceContext;
...
fn tool_dispatch_invocation(invocation: &ToolInvocation) -> Option<ToolDispatchInvocation> {
    ...
    Some(ToolDispatchInvocation {
        ...
        workx_turn_id: invocation.turn.sub_id.clone(),

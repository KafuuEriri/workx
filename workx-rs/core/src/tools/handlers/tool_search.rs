...
use workx_tools::TOOL_SEARCH_DEFAULT_LIMIT;
use workx_tools::TOOL_SEARCH_TOOL_NAME;
use workx_tools::ToolName;
use workx_tools::ToolSearchEntry;
use workx_tools::ToolSearchInfo;
use workx_tools::ToolSpec;
use workx_tools::coalesce_loadable_tool_specs;
...
mod tests {
    ...
    fn mixed_search_results_coalesce_mcp_namespaces() {
        let dynamic_namespace = DynamicToolNamespaceSpec {
            ...
            description: "Tools in the workx_app namespace.".to_string(),
            tools: Vec::new(),
        };

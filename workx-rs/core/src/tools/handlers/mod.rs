...
use workx_sandboxing::policy_transforms::materialize_additional_permissions_with_context;
use workx_sandboxing::policy_transforms::merge_permission_profiles;
use workx_sandboxing::policy_transforms::normalize_additional_permissions_with_context;
...
pub(crate) fn normalize_and_validate_additional_permissions(
    ...
    context: &workx_protocol::permissions::FileSystemSandboxPolicyContext<'_>,
...
pub(super) fn file_system_sandbox_policy_context_for_cwd<'a>(
    ...
    cwd: &'a PathUri,
) -> Option<workx_protocol::permissions::FileSystemSandboxPolicyContext<'a>> {
    ...
    if effective_permissions
        ...
        .is_some_and(|permissions| {
            permissions.entries.iter().any(|entry| {
                (matches!(
                    &entry.path,
                    workx_protocol::permissions::FileSystemPath::Special {
                        value: workx_protocol::permissions::FileSystemSpecialPath::Tmpdir,
                    }
                ) && context
                    ...
                    &entry.path,
                    workx_protocol::permissions::FileSystemPath::Special {
                        value: workx_protocol::permissions::FileSystemSpecialPath::ProjectRoots { .. },
...
mod tests {
    ...
    use workx_sandboxing::policy_transforms::intersect_permission_profiles;
    use workx_sandboxing::policy_transforms::merge_permission_profiles;
    use workx_utils_absolute_path::AbsolutePathBuf;
    use workx_utils_path_uri::PathUri;

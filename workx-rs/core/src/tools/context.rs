...
use workx_protocol::models::function_call_output_content_items_to_text;
use workx_tools::LoadableToolSpec;
...
use workx_utils_output_truncation::formatted_truncate_text;
use workx_utils_output_truncation::truncate_function_output_payload;
use workx_utils_output_truncation::truncate_text;

pub use workx_tools::ToolOutput;
pub use workx_tools::ToolPayload;
...
pub enum ToolCallSource {
    ...
    CodeMode {
        ...
        /// debugging the JS/runtime bridge, but it is not the Workx tool call id
    ...
    pub(crate) async fn originating_item_id(&self) -> Option<ResponseItemId> {
        if let ToolCallSource::CodeMode { cell_id, .. } = &self.source {
            return self
                ...
                .services
                .code_mode_service
                .cell_originating_item_id(&workx_code_mode::CellId::new(cell_id.clone()));
        }

...
impl ToolCallRuntime {
    ...
    pub(crate) fn handle_tool_call(
    ...
    ) -> impl std::future::Future<Output = Result<ResponseItemEnvelope, WorkxErr>> {
        ...
        async move {
            match future.await {
                ...
                Err(FunctionCallError::Fatal(message)) => Err(WorkxErr::Fatal(message)),
    ...
    pub(crate) fn handle_tool_call_with_source(
        ...
        if self
            ...
            .config
            .features
            .enabled(workx_features::Feature::ExecutedToolCallMetadata)
    ...
    fn failure_response(call: ToolCall, err: FunctionCallError) -> ResponseInputItem {
        ...
        match call.payload {
            ...
            ToolPayload::Custom { .. } => ResponseInputItem::CustomToolCallOutput {
                call_id: call.call_id,
                name: None,
                output: workx_protocol::models::FunctionCallOutputPayload {
                    body: workx_protocol::models::FunctionCallOutputBody::Text(message),
                    success: Some(false),
                },
            },
        ...
        macro_rules! log_tool_call {
            ($dispatch_duration_ms:expr, $handler_duration_ms:expr, $total_duration_ms:expr) => {
                info!(
                    ...
                    trace_id = %workx_otel::current_span_trace_id().unwrap_or_default(),
...
mod tests {
    ...
    async fn cancellation_before_dispatch_admission_logs_dispatch_only_timing() -> anyhow::Result<()>
    {
        ...
        let tool_name = workx_tools::ToolName::plain("test_tool");
        ...
        let timing_events = logs
            .lines()
            .filter(|line| line.contains("event.name=\"workx.tool_call\""))
            .collect::<Vec<_>>();
        assert_eq!(
            timing_events.len(),
            1,
    ...
    impl workx_extension_api::ToolLifecycleContributor for BlockingFinishContributor {
        fn on_tool_finish<'a>(
            &'a self,
    ...
    -> anyhow::Result<()> {
        ...
        let mut builder =
            workx_extension_api::ExtensionRegistryBuilder::<crate::config::Config>::new();

...
use workx_analytics::ControlToolCallStatus;
...
use workx_shell_command::parse_command::parse_shell_script;
use workx_tools::ToolName;
use workx_tools::ToolSpec;

pub(crate) type ToolTelemetryTags = Vec<(&'static str, String)>;

pub use workx_tools::ToolExecutor;
pub use workx_tools::ToolExposure;
    ...
    pub(crate) fn into_response(self) -> ResponseItemEnvelope {
        ...
        ResponseItemEnvelope {
            ...
            metadata: result
                ...
                .map(|limit| WorkxHarnessMetadata {
...
impl ToolOutput for PostToolUseFeedbackOutput {
    ...
    fn tool_result_sources(&self) -> Option<workx_protocol::models::ToolResultSources> {

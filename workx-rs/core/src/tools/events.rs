...
use workx_analytics::ArtifactOperation;
use workx_analytics::ArtifactOperationLifecycle;
use workx_analytics::build_track_events_context;
use workx_apply_patch::AppliedPatchDelta;
use workx_core_plugins::PluginCommandAttribution;
use workx_core_plugins::recognize_artifact_operation;
use workx_otel::ARTIFACT_OPERATION_EXPECTED_OUTPUT_COUNT_METRIC;
use workx_otel::ARTIFACT_OPERATION_STARTED_METRIC;
...
use workx_protocol::items::CommandExecutionStatus;
...
impl ToolEmitter {
    ...
    pub async fn finish(
        ...
        let (event, result) = match out {
            ...
            Err(ToolError::Workx(err)) => match err.details() {
...
mod tests {
    ...
    async fn assert_failed_apply_patch_tracks_committed_delta(
        ...
        let delta = workx_apply_patch::apply_patch(
    ...
    async fn denied_apply_patch_tracks_committed_delta() {
        ...
        assert_failed_apply_patch_tracks_committed_delta(
            Err(ToolError::Workx(WorkxErr::Sandbox(SandboxErr::Denied {

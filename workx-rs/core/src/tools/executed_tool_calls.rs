...
use workx_protocol::models::ExecutedToolCall;
use workx_protocol::models::ExecutedToolCallArguments;
use workx_protocol::models::ResponseItem;
use workx_protocol::models::bound_executed_tool_calls_for_prompt_prioritizing_recent;
use workx_protocol::models::executed_tool_call_metadata_bytes;
...
impl ExecutedToolCallRecorder {
    pub(crate) fn record_tool_call(
        ...
        let name = workx_tools::code_mode_name_for_tool_name(&call.tool_name);
    ...
    pub(crate) fn record_tool_result_sources(
        ...
        source: &ToolCallSource,
        call_id: &str,
        result_sources: workx_protocol::models::ToolResultSources,
    ) -> bool {
        let mut state = self
            .state
            .lock()

...
use workx_apply_patch::ApplyPatchOptions;
...
use workx_sandboxing::is_likely_executor_managed_sandbox_denied;
...
impl ToolRuntime<ApplyPatchRequest, ApplyPatchRuntimeOutput> for ApplyPatchRuntime {
    ...
    async fn run(
        ...
        let result = workx_apply_patch::apply_patch_with_options(
            &req.action.patch,
            ApplyPatchOptions {

...
) -> workx_tools::ToolUserShellType {
    match user_shell.shell_type {
        crate::shell::ShellType::Zsh => workx_tools::ToolUserShellType::Zsh,
        crate::shell::ShellType::Bash => workx_tools::ToolUserShellType::Bash,
        crate::shell::ShellType::PowerShell => workx_tools::ToolUserShellType::PowerShell,
        crate::shell::ShellType::Sh => workx_tools::ToolUserShellType::Sh,
        crate::shell::ShellType::Cmd => workx_tools::ToolUserShellType::Cmd,
    }
}

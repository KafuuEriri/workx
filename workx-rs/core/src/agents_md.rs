...
use workx_config::default_project_root_markers;
use workx_config::merge_toml_values;
use workx_config::project_root_markers_from_config;
...
impl LoadedAgentsMd {
    ...
    /// compile `workx-core` as a normal dependency without that configuration.

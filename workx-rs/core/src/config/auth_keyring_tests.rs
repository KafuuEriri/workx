...
use workx_config::config_toml::ForcedChatgptWorkspaceIds;
...
fn managed_auth_restrictions_intersect_workspaces_and_fail_closed() {
    ...
    let auth_config = bootstrap_auth_config(Path::new("workx-home"), &bootstrap_config)
    ...
    assert_eq!(
        bootstrap_auth_config(Path::new("workx-home"), &bootstrap_config)

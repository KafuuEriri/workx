...
use workx_git_utils::ApplyGitRequest;
use workx_git_utils::apply_git_patch;
...
async fn apply_verified_patch(root: &Path, patch: &str) -> AppliedPatchDelta {
    ...
    match workx_apply_patch::maybe_parse_apply_patch_verified(
        &argv,
        &cwd,
        LOCAL_FS.as_ref(),
        /*sandbox*/ None,

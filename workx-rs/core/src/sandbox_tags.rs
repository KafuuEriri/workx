...
use workx_sandboxing::policy_transforms::should_require_platform_sandbox;
...
impl SandboxTags {
    ...
    pub(crate) fn record_metadata(&self, metadata: &mut WorkxResponsesMetadata) {
...
pub(crate) fn record_policy_metadata(
    profile: &PermissionProfile,
    cwd: &Path,
    metadata: &mut WorkxResponsesMetadata,
) {

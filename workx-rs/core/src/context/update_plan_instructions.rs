//! Omits checklist-tool guidance from Workx-owned prompts, before adding caller text.

/// Call only for Workx-owned prompt text; custom instructions must remain unchanged.

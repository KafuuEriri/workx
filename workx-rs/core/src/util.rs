...
/// `workx_feedback::WorkxFeedback::metadata_layer()` is installed, these fields are captured and
...
///
/// workx_core::feedback_tags!(model = "gpt-5", cached = true);
/// workx_core::feedback_tags!(provider = provider_id, request_id = request_id);
/// ```
#[macro_export]

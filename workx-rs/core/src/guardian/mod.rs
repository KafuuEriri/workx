...
pub(crate) const AUTO_REVIEW_DENIED_ACTION_APPROVAL_DEVELOPER_PREFIX: &str =
    workx_guardian_context::MANUAL_APPROVAL_DEVELOPER_PREFIX;
...
pub(crate) struct GuardianAssessment {
    pub(crate) risk_level: workx_protocol::protocol::GuardianRiskLevel,
    pub(crate) user_authorization: workx_protocol::protocol::GuardianUserAuthorization,

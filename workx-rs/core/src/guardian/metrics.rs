...
use workx_otel::GUARDIAN_REVIEW_COUNT_METRIC;
use workx_otel::GUARDIAN_REVIEW_DURATION_METRIC;
use workx_otel::GUARDIAN_REVIEW_TOKEN_USAGE_METRIC;
use workx_otel::GUARDIAN_REVIEW_TTFT_DURATION_METRIC;
...
mod tests {
    ...
    #[test_case(
        GuardianReviewedAction::NetworkAccess {
            protocol: workx_protocol::approvals::NetworkApprovalProtocol::Https,
            port: 443,
        },
        "network_access",
        BTreeMap::new();
    ...
    #[test_case(
        GuardianReviewedAction::McpToolCall {
            server: "workx_apps_custom".to_string(),

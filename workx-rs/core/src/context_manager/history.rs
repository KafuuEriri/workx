...
use workx_guardian_context::TranscriptHistory;
use workx_history::GuardianHistoryCheckpoint;
...
use workx_utils_cache::BlockingLruCache;
use workx_utils_cache::sha1_digest;
...
use workx_utils_output_truncation::approx_tokens_from_byte_count_i64;
use workx_utils_output_truncation::truncate_function_output_payload;
...
impl ContextManager {
    ...
    where
        I: IntoIterator<Item = (T, Option<&'a WorkxHarnessMetadata>)>,

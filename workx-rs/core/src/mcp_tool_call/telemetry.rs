...
const MCP_CALL_COUNT_METRIC: &str = "workx.mcp.call";
const MCP_CALL_DURATION_METRIC: &str = "workx.mcp.call.duration_ms";
const MCP_CALL_ERROR_COUNT_METRIC: &str = "workx.mcp.call.error";
...
const MCP_CALL_ERROR_CODE_SPAN_ATTR: &str = "workx.mcp.error.code";
            ...
            let error_code = result
                ...
                .or_else(|| {
                    result
                        ...
                        .and_then(JsonValue::as_object)
                        .and_then(|workx_apps| workx_apps.get("connector_auth_failure"))
                        .and_then(JsonValue::as_object)
                        .filter(|auth_failure| {
                            auth_failure
                                .get("is_auth_failure")

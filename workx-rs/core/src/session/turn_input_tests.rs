...
async fn accepted_input_applies_thread_settings() {
    ...
    handle(
        ...
        .with_thread_settings(ThreadSettingsOverrides {
            ...
            approvals_reviewer: Some(workx_config::types::ApprovalsReviewer::AutoReview),
    ...
    assert_eq!(
        ...
        workx_config::types::ApprovalsReviewer::AutoReview
    );
    assert!(
...
async fn automatic_admission_rechecks_plan_mode_without_committing_sparse_settings() {
    ...
    impl workx_extension_api::ConfigContributor<crate::config::Config> for ConfigRecorder {
        fn on_config_changed(
            &self,
            _session_store: &workx_extension_api::ExtensionData,
            _thread_store: &workx_extension_api::ExtensionData,
...
async fn admission_revalidates_constraints_before_committing(kind: TurnStartKind) {
    ...
    let expected_message = WorkxErr::InvalidRequest(
        approval_policy
    ...
    let WorkxErrorDetails::InvalidRequest(message) = error.details() else {

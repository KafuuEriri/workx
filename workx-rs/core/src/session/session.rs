...
pub(crate) struct Session {
    ...
    pub(super) mcp_elicitation_reviewer_handle: OnceLock<workx_mcp::ElicitationReviewerHandle>,
    pub(super) mcp_elicitation_lifecycle_handle: OnceLock<workx_mcp::ElicitationLifecycle>,
...
pub(crate) struct SessionConfiguration {
    ...
    /// Directory containing all Workx state for this session.
    pub(super) workx_home: AbsolutePathBuf,
...
impl SessionConfiguration {
    ...
    pub(crate) fn workx_home(&self) -> &AbsolutePathBuf {
        &self.workx_home
    }
    ...
    pub(super) fn thread_config_snapshot(
        ...
        ThreadConfigSnapshot {
            ...
            full_access: workx_protocol::protocol::has_full_access(
            ...
            if let Some(active_permission_profile) = next_configuration.active_permission_profile()
            {
                ...
                config.permissions.network = config
                    ...
                    .map_err(|err| ConstraintError::InvalidValue {
                        ...
                        requirement_source: workx_config::RequirementSource::Unknown,
                    })?;
                config
                    .permissions
...
async fn warm_plugins_and_skills_for_session_init(
    ...
    extensions: &workx_extension_api::ExtensionRegistry<Config>,
) -> Vec<SkillError> {
...
impl Session {
    ...
    pub(crate) async fn responses_metadata(
        ...
        request_kind: WorkxResponsesRequestKind,
    ...
    pub(crate) async fn new(
        ...
        environment_selections: &[TurnEnvironmentSelection],
        config: Arc<Config>,
        user_instructions: Option<workx_extension_api::Instructions>,
        ...
        code_mode_session_provider: Arc<dyn workx_code_mode::CodeModeSessionProvider>,
        extensions: Arc<workx_extension_api::ExtensionRegistry<crate::config::Config>>,
        ...
        windows_sandbox_proxy_settings_mode: workx_sandboxing::WindowsSandboxProxySettingsMode,
            ...
            ForkPersistence::Copied => match &initial_history {
                InitialHistory::Resumed(resumed) => {
                    ...
                    resumed.history.first().and_then(|item| match item {
                        ...
                        {
                            workx_rollout::forked_from_ordinal_exclusive(
                                &meta.meta,
        ...
        thread_extension_init.insert(workx_extension_api::ThreadOriginator(
            session_configuration.originator.clone(),
        ));
        let mcp_thread_init = thread_extension_init.clone();
        let thread_extension_data = workx_extension_api::ExtensionData::new_with_init(
            thread_id.to_string(),
        ...
        let session_result: anyhow::Result<Arc<Self>> = async {
            ...
            let config_path = config.workx_home.join(CONFIG_TOML_FILE);
            ...
            let auth_mode = telemetry_auth
                .map(WorkxAuth::auth_mode)
                .map(TelemetryAuthMode::from);
            let account_id = telemetry_auth.and_then(WorkxAuth::get_account_id);
            let account_email = telemetry_auth.and_then(WorkxAuth::get_account_email);
            ...
            let auth_env_telemetry = collect_auth_env_telemetry(
                ...
                auth_manager.workx_api_key_env_enabled(),
            );
            ...
            let mcp_server_names =
                workx_mcp::effective_mcp_servers(
            ...
            let session_extension_data =
                workx_extension_api::ExtensionData::new(session_id.to_string());
            ...
            for contributor in extensions.thread_lifecycle_contributors() {
                contributor.on_thread_start(workx_extension_api::ThreadStartInput {
            ...
            let session_start_source = match &initial_history {
                InitialHistory::Resumed(_) => workx_hooks::SessionStartSource::Resume,
                InitialHistory::New | InitialHistory::Forked(_) => {
                    workx_hooks::SessionStartSource::Startup
                }
                InitialHistory::Cleared => workx_hooks::SessionStartSource::Clear,
            };

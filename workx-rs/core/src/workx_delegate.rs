...
/// Start an interactive sub-Workx thread and return its runtime and IO channels.
///
...
pub(crate) async fn run_workx_thread_interactive(
    mut config: Config,
...
#[allow(clippy::too_many_arguments)]
pub(crate) async fn run_workx_thread_one_shot(
    config: Config,
    auth_manager: Arc<AuthManager>,
    models_manager: SharedModelsManager,
    input: Vec<UserInput>,

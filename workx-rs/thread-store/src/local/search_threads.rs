...
use workx_rollout::first_rollout_content_match_snippet;
use workx_rollout::parse_cursor;
use workx_rollout::search_rollout_matches;
...
pub(super) async fn search_threads(
    ...
    loop {
        ...
        for item in page.items {
            let logical_path = workx_rollout::plain_rollout_path(item.path.as_path());

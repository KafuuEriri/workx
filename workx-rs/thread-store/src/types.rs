...
use workx_protocol::protocol::ThreadMemoryMode as MemoryMode;
...
pub struct CreateThreadParams {
    ...
    /// Thread id generated by Workx before opening persistence.
...
pub struct StoredTurnError {
    ...
    pub message: String,
    /// Structured Workx error classification, when available.
...
mod tests {
    ...
    fn session_meta(history_mode: ThreadHistoryMode) -> RolloutItem {
        RolloutItem::SessionMeta(workx_protocol::protocol::SessionMetaLine {

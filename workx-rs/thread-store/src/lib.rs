...
//!
//! Application code should treat [`workx_protocol::ThreadId`] as the only durable thread handle.
...
pub use workx_state::MAX_QUEUE_ITEMS;
pub use workx_state::ProjectSortKey;
pub use workx_state::QueuedUserSubmissionRecord;

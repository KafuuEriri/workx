...
use super::WorkxHarnessMetadata;
...
pub(super) enum RolloutItemWire<'a> {
    ...
    ResponseItem {
        ...
        metadata: Option<Cow<'a, WorkxHarnessMetadata>>,
    },
...
pub(super) struct CompactedItemWire<'a> {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    replacement_history_metadata: Option<Vec<Cow<'a, WorkxHarnessMetadata>>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
            ...
            .map(|items| {
                items
                    ...
                    .map(|envelope| match envelope.metadata.as_ref() {
                        ...
                        None => Cow::Owned(WorkxHarnessMetadata::default()),
                    })
                    .collect()
            });

//! Plugin path resolution, plaintext mention sigils, and MCP connector helpers shared across Workx
//! crates.
...
pub use workx_exec_server_protocol::DISCOVERABLE_PLUGIN_MANIFEST_PATHS;
...
const PLUGIN_METADATA_DIR: &str = ".workx-plugin";

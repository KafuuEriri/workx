# workx-utils-stream-parser

Small, dependency-free utilities for parsing streamed text incrementally.

**Disclaimer**: This code is pretty complex and Workx did not manage to write it so before updating the code, make
sure to deeply understand it and don't blindly trust Workx on it. Feel free to update the documentation as you
modify the code
...
```rust
use workx_utils_stream_parser::CitationStreamParser;
use workx_utils_stream_parser::StreamTextParser;
...
```rust
use workx_utils_stream_parser::CitationStreamParser;
use workx_utils_stream_parser::Utf8StreamParser;

# fn demo() -> Result<(), workx_utils_stream_parser::Utf8StreamParserError> {
...
```rust
use workx_utils_stream_parser::InlineHiddenTagParser;
use workx_utils_stream_parser::InlineTagSpec;
use workx_utils_stream_parser::StreamTextParser;

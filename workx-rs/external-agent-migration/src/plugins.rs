...
use workx_core_plugins::PluginInstallError;
...
use workx_core_plugins::marketplace_add::is_local_marketplace_source;
    ...
    pub async fn import_plugins(
        ...
        let config = ConfigBuilder::default()
            ...
            .fallback_cwd(Some(
                cwd.map(Path::to_path_buf)
                    .unwrap_or_else(|| self.workx_home.clone()),
            ))
            .build()
            .await
        ...
        for plugin_group in plugins {
                ...
                configured_marketplace_paths.get(&marketplace_name)
            {
                ...
                match add_marketplace(self.workx_home.clone(), requirements.clone(), request).await
                {

...
use workx_app_server_protocol::HookOutputEntry;
use workx_app_server_protocol::HookOutputEntryKind;
use workx_app_server_protocol::HookRunStatus;
use workx_app_server_protocol::HookRunSummary;
...
mod tests {
    ...
    fn completed_hook_with_only_context_is_quiet_on_every_tui_surface() {
        let cell = completed_hook_cell(
            ...
            vec![HookOutputEntry {
                kind: HookOutputEntryKind::Context,
                text: "## Working Memory Recall\n\nSource: Workx compaction".to_string(),
            }],
        );

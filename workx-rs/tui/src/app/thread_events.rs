...
impl ThreadEventStore {
    ...
    pub(super) fn file_change_changes(
        ...
        turn_id: &str,
        item_id: &str,
    ) -> Option<Vec<workx_app_server_protocol::FileUpdateChange>> {
...
mod tests {
    ...
    use workx_app_server_protocol::HookEventName as AppServerHookEventName;
    use workx_app_server_protocol::HookExecutionMode as AppServerHookExecutionMode;
    use workx_app_server_protocol::HookHandlerType as AppServerHookHandlerType;
    use workx_app_server_protocol::HookOutputEntry as AppServerHookOutputEntry;
    use workx_app_server_protocol::HookOutputEntryKind as AppServerHookOutputEntryKind;
    use workx_app_server_protocol::HookRunStatus as AppServerHookRunStatus;
    use workx_app_server_protocol::HookRunSummary as AppServerHookRunSummary;
    use workx_app_server_protocol::HookScope as AppServerHookScope;
    use workx_app_server_protocol::HookStartedNotification;
    use workx_app_server_protocol::McpToolCallProgressNotification;
    ...
    fn thread_event_store_rebase_preserves_mcp_startup_notifications() {
        ...
        let notification = ServerNotification::McpServerStatusUpdated(
            workx_app_server_protocol::McpServerStatusUpdatedNotification {
                thread_id: Some(thread_id.to_string()),
                name: "sentry".to_string(),
                status: workx_app_server_protocol::McpServerStartupState::Failed,

        ...
        let editor_cmd = match external_editor::resolve_editor_command() {
            ...
            Err(external_editor::EditorError::MissingEditor) => {
                self.chat_widget
                    ...
                    "Cannot open external editor: set $VISUAL or $EDITOR before starting Workx."
                        .to_string(),
                ));
            ...
            if let Some(thread_id) = running_thread_id {
                ...
                self.chat_widget.show_selection_view(SelectionViewParams {
                    ...
                    items: [
                        (
                            "Cancel task",
                            "Stop the current task and stay in Workx",
                            RunningTaskExitAction::CancelTask,
                        ),
                        (
                            "Run in background",
                            "Exit Workx and leave the task running",
                            RunningTaskExitAction::RunInBackground,
                        ),
                        (
                            "Exit",
                            "Stop the current task and exit Workx",

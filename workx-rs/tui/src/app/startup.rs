...
impl App {
    ...
    pub async fn run(
        ...
        let has_workx_backend_auth = matches!(auth_mode, Some(TelemetryAuthMode::Chatgpt));
        ...
        let session_telemetry = SessionTelemetry::new(
            ...
            auth_mode,
            workx_login::default_client::originator().value,
        ...
        {
            session_telemetry.counter("workx.status_line", /*inc*/ 1, &[]);
        }
...
See the Workx keymap documentation for supported actions and examples."
        ...
        #[cfg(target_os = "windows")]
        {
            ...
            if should_check {
                ...
                let logs_base_dir = app.config.workx_home.clone();

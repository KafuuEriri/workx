...
use workx_app_server_protocol::ThreadBackgroundTerminalsListResponse as ListResponse;
...
impl App {
    ...
    pub(super) async fn change_working_directory(
        ...
        if config.active_project.trust_level.is_none() {
            return self.working_directory_error("This directory is not trusted; run Workx there.");
        }

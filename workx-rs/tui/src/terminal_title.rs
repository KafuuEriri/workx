...
//! "leave the old title alone" or "clear the title Workx last wrote".
...
pub(crate) enum SetTerminalTitleResult {
    ...
    /// the title Workx manages, or some other fallback.
    NoVisibleContent,
}
...
/// or a previous program may have set before Workx started managing the title.

...
const ANNOUNCEMENT_TIP_URL: &str =
    "https://raw.githubusercontent.com/RonanXiao/workx/main/announcement_tip.toml";

const IS_MACOS: bool = cfg!(target_os = "macos");
const IS_WINDOWS: bool = cfg!(target_os = "windows");

const APP_TOOLTIP: &str = "Try the **Desktop app**. Run 'workx app' or visit https://chatgpt.com/codex?app-landing-page=true";
const MACOS_APP_TOOLTIP: &str =
    "Run `workx app` to open the Desktop app (it installs on macOS if needed).";
...
const OTHER_TOOLTIP: &str = "*New* Build faster with the **Desktop app**. Run 'workx app' or visit https://chatgpt.com/codex?app-landing-page=true";
const OTHER_TOOLTIP_NON_MAC: &str = "*New* Build faster with Workx.";
const FREE_GO_TOOLTIP: &str =
    "*New* For a limited time, Workx is included in your plan for free – let’s build together.";
...
/// Pick a random tooltip to show to the user when starting Workx.
...
pub(crate) mod announcement {
    ...
    impl TargetOs {
        const fn current() -> Self {
            if cfg!(target_os = "macos") {
                ...
                // Workx currently publishes CLI builds for macOS, Windows, and Linux.
                Self::Linux
            }
        }
    }
    ...
    pub(crate) fn parse_announcement_tip_toml(
        ...
        for raw in announcements {
            ...
            if tip.version_matches(WORKX_CLI_VERSION)
...
mod tests {
    ...
    fn desktop_app_tooltip_uses_supported_platform_launcher() {
        ...
        if linux_app_tooltip(LinuxDesktopSession::current()).is_some() {
            ...
            insta::assert_snapshot!(tooltip, @"Run `workx app` to open the Desktop app (it installs on macOS if needed).");
...
from_date = "2000-01-01"
    ...
    fn announcement_tip_toml_parse_comments() {
        let toml = r#"
# Example announcement tips for Workx TUI.
...
[[announcements]]
content = "Welcome to Workx! Check out the new onboarding flow."

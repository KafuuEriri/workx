...
/// Restore the terminal after Workx is exiting.
///
...
impl Tui {
    pub(crate) fn new(
        ...
        let scrollback = ScrollbackStrategy::detect(&workx_terminal_detection::terminal_info());
    ...
    /// terminal modes and stderr while keeping raw mode enabled, then re-applies Workx TUI modes

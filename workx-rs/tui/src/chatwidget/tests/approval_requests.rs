...
async fn app_server_write_stdin_approval_renders_terminal_input() {
    ...
    let event = exec_approval_request_from_params(
        AppServerCommandExecutionRequestApprovalParams {
            kind: workx_app_server_protocol::CommandExecutionApprovalKind::WriteStdin,
            thread_id: "thread-1".to_string(),
            turn_id: "turn-1".to_string(),
            item_id: "item-1".to_string(),
            started_at_ms: 0,
...
fn app_server_exec_approval_request_preserves_permissions_context() {
    ...
    let request = exec_approval_request_from_params(
        AppServerCommandExecutionRequestApprovalParams {
            ...
            environment_id: None,
            reason: None,
            network_approval_context: Some(workx_app_server_protocol::NetworkApprovalContext {
                host: "example.com".to_string(),
                protocol: workx_app_server_protocol::NetworkApprovalProtocol::Socks5Tcp,
            }),
    ...
    assert_eq!(
        ...
        Some(workx_app_server_protocol::NetworkApprovalContext {
            host: "example.com".to_string(),
            protocol: workx_app_server_protocol::NetworkApprovalProtocol::Socks5Tcp,
        })
    );
...
async fn network_exec_approval_history_describes_session_host_allowance() {
    ...
    let request = exec_approval_request_from_params(
        AppServerCommandExecutionRequestApprovalParams {
            ...
            network_approval_context: Some(workx_app_server_protocol::NetworkApprovalContext {
                host: "example.com".to_string(),
                protocol: workx_app_server_protocol::NetworkApprovalProtocol::Https,
            }),
...
async fn network_exec_approval_history_describes_one_time_host_allowance() {
    ...
    let request = exec_approval_request_from_params(
        AppServerCommandExecutionRequestApprovalParams {
            ...
            network_approval_context: Some(workx_app_server_protocol::NetworkApprovalContext {
                host: "example.com".to_string(),
                protocol: workx_app_server_protocol::NetworkApprovalProtocol::Http,
            }),
            command: None,
            cwd: None,
            command_actions: None,

...
impl ChatWidget {
    ...
    pub(super) fn on_guardian_review_notification(
        ...
        turn_id: String,
        started_at_ms: i64,
        review: workx_app_server_protocol::GuardianApprovalReview,
        completion: Option<(i64, workx_app_server_protocol::AutoReviewDecisionSource)>,
        ...
        self.on_guardian_assessment(GuardianAssessmentEvent {
            ...
            status: match review.status {
                workx_app_server_protocol::GuardianApprovalReviewStatus::InProgress => {
                    GuardianAssessmentStatus::InProgress
                }
                workx_app_server_protocol::GuardianApprovalReviewStatus::Approved => {
                    GuardianAssessmentStatus::Approved
                }
                workx_app_server_protocol::GuardianApprovalReviewStatus::Denied => {
                    GuardianAssessmentStatus::Denied
                }
                workx_app_server_protocol::GuardianApprovalReviewStatus::TimedOut => {
                    GuardianAssessmentStatus::TimedOut
                }
                workx_app_server_protocol::GuardianApprovalReviewStatus::Aborted => {
                    GuardianAssessmentStatus::Aborted
                }
            },
            risk_level: review.risk_level.map(|risk_level| match risk_level {
                workx_app_server_protocol::GuardianRiskLevel::Low => {
                    workx_protocol::approvals::GuardianRiskLevel::Low
                }
                workx_app_server_protocol::GuardianRiskLevel::Medium => {
                    workx_protocol::approvals::GuardianRiskLevel::Medium
                }
                workx_app_server_protocol::GuardianRiskLevel::High => {
                    workx_protocol::approvals::GuardianRiskLevel::High
                }
                workx_app_server_protocol::GuardianRiskLevel::Critical => {
                    workx_protocol::approvals::GuardianRiskLevel::Critical
                }
            }),
            user_authorization: review.user_authorization.map(|user_authorization| {
                match user_authorization {
                    workx_app_server_protocol::GuardianUserAuthorization::Unknown => {
                        workx_protocol::approvals::GuardianUserAuthorization::Unknown
                    }
                    workx_app_server_protocol::GuardianUserAuthorization::Low => {
                        workx_protocol::approvals::GuardianUserAuthorization::Low
                    }
                    workx_app_server_protocol::GuardianUserAuthorization::Medium => {
                        workx_protocol::approvals::GuardianUserAuthorization::Medium
                    }
                    workx_app_server_protocol::GuardianUserAuthorization::High => {
                        workx_protocol::approvals::GuardianUserAuthorization::High
                    }
                }
            }),
            rationale: review.rationale,
            decision_source: decision_source.map(|source| match source {
                workx_app_server_protocol::AutoReviewDecisionSource::Agent => {

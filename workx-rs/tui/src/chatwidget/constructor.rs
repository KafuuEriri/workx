...
impl ChatWidget {
    pub(crate) fn new_with_app_event(common: ChatWidgetInit) -> Self {
        Self::new_with_op_target(common, WorkxOpTarget::AppEvent)
    }
    ...
    pub(super) fn new_with_op_target(
        ...
        let pet_http_client = workx_http_client::RouteAwareClientPool::new(
            config.http_client_factory(),
            workx_http_client::ClientRouteClass::Other,
        );
        ...
        let mut widget = Self {
            ...
            workx_rate_limit_reached_type: None,
            workx_spend_control_reached: None,
        ...
        widget
            .bottom_pane
            .set_token_activity_command_enabled(widget.has_workx_backend_auth);

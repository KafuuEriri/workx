...
impl ChatWidget {
        ...
        match cmd {
            ...
            SlashCommand::Archive => {
                self.bottom_pane.show_selection_view(SelectionViewParams {
                    ...
                    subtitle: Some(
                        "Are you sure? This will archive the current session and exit Workx"
                            .to_string(),
                    ),
            ...
            SlashCommand::ElevateSandbox => {
                #[cfg(target_os = "windows")]
                {
                    ...
                    self.session_telemetry.counter(
                        "workx.windows_sandbox.setup_elevated_sandbox_command",
                        /*inc*/ 1,
                        &[],
                    );
                    self.app_event_tx
    ...
    fn builtin_command_flags(&self) -> BuiltinCommandFlags {
        ...
        BuiltinCommandFlags {
            ...
            token_activity_command_enabled: self.has_workx_backend_auth,

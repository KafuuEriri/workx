...
pub(crate) struct ThreadSessionState {
    ...
    pub(crate) approvals_reviewer: workx_protocol::config_types::ApprovalsReviewer,
    ...
    pub(crate) reasoning_effort: Option<workx_protocol::openai_models::ReasoningEffort>,

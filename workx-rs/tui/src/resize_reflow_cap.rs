...
//! the fallback bucket.
//!
//! These caps are deliberately conservative: Workx is rebuilding normal terminal scrollback, not an
...
use workx_config::types::DEFAULT_TERMINAL_RESIZE_REFLOW_FALLBACK_MAX_ROWS;

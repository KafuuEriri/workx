...
impl TerminalTitleItem {
    pub(crate) fn description(self) -> &'static str {
        match self {
            TerminalTitleItem::AppName => "Workx app name",
            ...
            TerminalTitleItem::WorkxVersion => "Workx application version",
    ...
    pub(crate) fn preview_item(self) -> Option<StatusSurfacePreviewItem> {
        match self {
            ...
            TerminalTitleItem::WorkxVersion => Some(StatusSurfacePreviewItem::WorkxVersion),
    ...
    fn parse_terminal_title_items_accepts_kebab_case_variants() {
        ...
        assert_eq!(
            ...
            Some(vec![
                ...
                TerminalTitleItem::WeeklyLimit,
                TerminalTitleItem::WorkxVersion,

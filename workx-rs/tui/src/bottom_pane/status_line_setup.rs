...
pub(crate) enum StatusLineItem {
    ...
    /// Hostname of the machine running Workx.
    Hostname,
...
impl StatusLineItem {
    ...
    pub(crate) fn description(self) -> &'static str {
        match self {
            ...
            StatusLineItem::WorkxVersion => "Workx application version",
    ...
    pub(crate) fn preview_item(self) -> StatusSurfacePreviewItem {
        match self {
            ...
            StatusLineItem::WorkxVersion => StatusSurfacePreviewItem::WorkxVersion,

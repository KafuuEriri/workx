...
use workx_app_server_protocol::AuthMode as ApiAuthMode;
...
pub(super) fn onboarding_request_id() -> workx_app_server_protocol::RequestId {
    workx_app_server_protocol::RequestId::String(Uuid::new_v4().to_string())
}
...
pub(super) async fn cancel_login_attempt(
    ...
    let _ = request_handle
        .request_typed::<workx_app_server_protocol::CancelLoginAccountResponse>(
...
impl AuthModeWidget {
    ...
    fn render_pick_mode(&self, area: Rect, buf: &mut Buffer) {
        let mut lines: Vec<Line> = if self.bedrock_setup_enabled {
            vec!["  Choose how you want to use Workx.".into(), "".into()]
        } else {
            vec![
                Line::from(vec![
                    "  ".into(),
                    "Sign in with ChatGPT to use Workx as part of your paid plan".into(),
                ]),
                Line::from(vec![
                    "  ".into(),
    ...
    fn render_chatgpt_success_message(&self, area: Rect, buf: &mut Buffer) {
        ...
        let lines = vec![
            ...
            "".into(),
            "  Decide how much autonomy you want to grant Workx".into(),
            docs_line,
            "".into(),
            "  Workx can make mistakes".into(),
            HyperlinkLine::new(
    ...
    fn render_api_key_configured(&self, area: Rect, buf: &mut Buffer) {
        let lines = vec![
            ...
            "".into(),
            "  Workx will use usage-based billing with your API key.".into(),
        ];
...
pub(super) mod tests {
    ...
    pub(in crate::onboarding) async fn widget_forced_chatgpt() -> (AuthModeWidget, TempDir) {
        ...
        let config = ConfigBuilder::default()
            .workx_home(workx_home_path.clone())
            .build()
            .await
            .unwrap();
        ...
        let client = InProcessAppServerClient::start(InProcessClientStartArgs {
            ...
            environment_manager: Arc::new(
                workx_app_server_client::EnvironmentManager::default_for_tests(),
            ),
    ...
    async fn bedrock_option_requires_feature_and_api_login_permission() {
        ...
        insta::assert_snapshot!(rows.join("\n"), @r###"
          Choose how you want to use Workx.
    ...
    fn chatgpt_success_message_renders_osc8_hyperlinks() {
        ...
        ✓ Signed in with your ChatGPT account
          ...
          Decide how much autonomy you want to grant Workx
          For more details see the Workx docs

          Workx can make mistakes
          Review the code it writes and commands it runs

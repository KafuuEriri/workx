...
pub(crate) use workx_utils_absolute_path::test_support::PathBufExt;
pub(crate) use workx_utils_absolute_path::test_support::test_path_buf;
...
where
    T: DeserializeOwned,
{
    from_app_server_wire(workx_app_server_protocol::SessionSource::Cli)
}
...
where
    T: DeserializeOwned,
{
    from_app_server_wire(workx_app_server_protocol::SkillScope::User)
}
...
where
    T: DeserializeOwned,
{
    from_app_server_wire(workx_app_server_protocol::SkillScope::Repo)
}

...
pub use workx_utils_path::is_wsl;
...
mod tests {
    ...
    fn win_to_wsl_basic() {
        assert_eq!(
            win_path_to_wsl(r"C:\Temp\workx.zip").as_deref(),
            Some("/mnt/c/Temp/workx.zip")
        );
        assert_eq!(
            win_path_to_wsl("D:/Work/workx.tgz").as_deref(),
            Some("/mnt/d/Work/workx.tgz")
        );
        assert!(win_path_to_wsl("/home/user/workx").is_none());
    }

//! Captures how this Workx process was launched.
//!
...
/// Builds the process provenance row for the current Workx executable.
///
...
pub(super) fn search_check() -> DoctorCheck {
    ...
    if status != CheckStatus::Ok {
        check = check.remediation("Install ripgrep or repair the bundled Workx package.");
    }
    check
}

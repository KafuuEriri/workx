//! Diagnoses whether Workx update paths target the running installation.
//!
...
const HOMEBREW_CASK_API_URL: &str = "https://formulae.brew.sh/api/cask/workx.json";
#[cfg(all(target_os = "macos", target_arch = "x86_64"))]
const DESKTOP_UPDATE_URL: &str = "https://persistent.oaistatic.com/workx-app-prod/appcast-x64.xml";
#[cfg(all(target_os = "macos", not(target_arch = "x86_64")))]
const DESKTOP_UPDATE_URL: &str = "https://persistent.oaistatic.com/workx-app-prod/appcast.xml";
#[cfg(target_os = "macos")]
const BACKEND_DESKTOP_UPDATE_URL: &str = "https://chatgpt.com/backend-api/wham/app/appcast";
#[cfg(target_os = "windows")]
const DESKTOP_UPDATE_URL: &str =
    "https://persistent.oaistatic.com/workx-app-prod/windows-store-update.json";
...
pub(super) fn updates_check(config: &Config) -> DoctorCheck {
    ...
    let version_file = config.workx_home.join(VERSION_FILE_NAME);
...
fn windows_store_update(
    ...
    if manifest.schema_version == 0
        ...
        || manifest.package_identity != "OpenAI.Workx"
    {
...
fn update_action_label(context: &InstallContext) -> &'static str {
    match &context.method {
        InstallMethod::Npm => "npm install -g @ronanxiao/workx",
        InstallMethod::Bun => "bun install -g @ronanxiao/workx",
        InstallMethod::VitePlus => "vp install -g @ronanxiao/workx",
        InstallMethod::Pnpm => "pnpm add -g @ronanxiao/workx",
        InstallMethod::Brew => "brew upgrade --cask workx",
...
mod tests {
    ...
    fn macos_update_probe_uses_the_persisted_production_appcast_feed() {
        ...
        let state_directory = home
            .path()
            .join("Library/Application Support/com.ronanxiao.workx");
    ...
    async fn macos_staged_updates_require_a_newer_matching_extracted_bundle() {
        ...
        for (name, identity, build) in [
            ("newest", "com.ronanxiao.workx", "6268"),
            ("newer", "com.ronanxiao.workx", "6168"),
            ("older", "com.ronanxiao.workx", "6138"),
            ("different", "com.example.other", "9999"),
            ("invalid", "com.ronanxiao.workx", "invalid"),
        ] {
        ...
        write_macos_bundle(&linked, "com.ronanxiao.workx", "9999");

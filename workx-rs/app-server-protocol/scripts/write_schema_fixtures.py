...
def main() -> None:
    ...
    env = os.environ.copy()
    env["WORKX_APP_SERVER_SCHEMA_ROOT"] = str(schema_root)
    env["WORKX_APP_SERVER_SCHEMA_EXPERIMENTAL"] = "1" if args.experimental else "0"
    if args.prettier:
        env["WORKX_APP_SERVER_SCHEMA_PRETTIER"] = str(args.prettier)

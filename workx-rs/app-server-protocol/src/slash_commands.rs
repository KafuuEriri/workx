...
impl SlashCommand {
    ...
    pub fn description(self) -> &'static str {
        match self {
            ...
            SlashCommand::Init => "create an AGENTS.md file with instructions for Workx",
            ...
            SlashCommand::Quit | SlashCommand::Exit => "exit Workx",
            ...
            SlashCommand::Skills => "use skills to improve how Workx performs specific tasks",
            ...
            SlashCommand::Provider => "add, edit, or switch model providers",
            SlashCommand::Model => "choose what model and reasoning effort to use",
            SlashCommand::Ide => {
                "include current selection, open files, and other context from your IDE"
            }
            SlashCommand::Personality => "choose a communication style for Workx",
            ...
            SlashCommand::Permissions => "choose what Workx is allowed to do",
            ...
            SlashCommand::Logout => "log out of Workx",
    ...
    /// Alternative names that parse to this command.
    pub fn aliases(self) -> &'static [&'static str] {
        match self {
            SlashCommand::Pwd => &["cwd"],
            SlashCommand::Pets => &["pet"],

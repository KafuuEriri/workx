...
pub enum AuthMode {
    /// OpenAI API key provided by the caller and stored by Workx.
    ApiKey,
    /// ChatGPT OAuth managed by Workx (tokens persisted and refreshed by Workx).
    Chatgpt,
    ...
    Headers,
    /// Programmatic Workx auth backed by a registered Agent Identity.
    #[serde(rename = "agentIdentity")]
    #[ts(rename = "agentIdentity")]
    #[strum(serialize = "agentIdentity")]
    AgentIdentity,
    /// Programmatic Workx auth backed by a personal access token.
    #[serde(rename = "personalAccessToken")]
    #[ts(rename = "personalAccessToken")]
    #[strum(serialize = "personalAccessToken")]
    PersonalAccessToken,
    /// Amazon Bedrock bearer token managed by Workx.
    #[serde(rename = "bedrockApiKey")]
    #[ts(rename = "bedrockApiKey")]
    #[strum(serialize = "bedrockApiKey")]
    BedrockApiKey,
    /// Amazon Bedrock AWS access keys managed by Workx.
...
impl AuthMode {
    ...
    /// Returns whether this mode is backed by Workx services rather than a direct model API.
...
client_request_definitions! {
    ...
    /// Spawn a standalone process (argv vector) without a Workx sandbox.
...
/// Superset of [`workx_file_search::FileMatch`]
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, JsonSchema, TS)]
...
server_notification_definitions! {
    ...
    /// This event is internal-only. Used by Workx Cloud.
...
mod tests {
    ...
    fn jsonrpc_request_conversion_preserves_serde_enum_decoding() {
        let requests = [
            JSONRPCRequest {
                ...
                trace: Some(workx_protocol::protocol::W3cTraceContext {
    ...
    fn serialize_mcp_server_elicitation_request() -> Result<()> {
        ...
        let params = v2::McpServerElicitationRequestParams {
            ...
            server_name: "workx_apps".to_string(),
        ...
        let response = ClientResponse::ThreadStart {
            ...
            response: v2::ThreadStartResponse {
                ...
                instruction_sources: vec![
                    workx_utils_path_uri::LegacyAppPathString::from_abs_path(&absolute_path(
                        "/tmp/AGENTS.md",
                    )),
                ],
    ...
    fn account_serializes_fields_in_camel_case() -> Result<()> {
        ...
        let workx_managed_bedrock = v2::Account::AmazonBedrock {
            uses_workx_managed_credentials: true,
        };
        assert_eq!(
            json!({
                "type": "amazonBedrock",
                "usesWorkxManagedCredentials": true,
            }),
            serde_json::to_value(&workx_managed_bedrock)?,
        );
        ...
        assert_eq!(
            json!({
                "type": "amazonBedrock",
                "usesWorkxManagedCredentials": false,
            }),
    ...
    fn serialize_thread_realtime_start() -> Result<()> {
        let request = ClientRequest::ThreadRealtimeStart {
            ...
            params: v2::ThreadRealtimeStartParams {
                ...
                workx_response_handoff_channel_prefixes: Some(std::collections::BTreeMap::from([
        ...
        assert_eq!(
            json!({
                ...
                "params": {
                    ...
                    "workxResponsesAsItems": null,
                    "workxResponseItemPrefix": null,
                    "workxResponseHandoffMode": "bemTags",
        ...
        assert_eq!(
            json!({
                ...
                "params": {
                    ...
                    "workxResponsesAsItems": null,
                    "workxResponseItemPrefix": null,
                    "workxResponseHandoffMode": null,
                    "workxResponseHandoffChannelPrefixes": null,
                    "model": null,
                    "outputModality": "audio",
        ...
        let notification =
            ServerNotification::ThreadSettingsUpdated(v2::ThreadSettingsUpdatedNotification {
                ...
                thread_settings: v2::ThreadSettings {
                    ...
                    effort: None,
                    summary: None,
                    collaboration_mode: workx_protocol::config_types::CollaborationMode {
                        mode: workx_protocol::config_types::ModeKind::Default,

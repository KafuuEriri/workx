...
pub enum ConfigLayerSource {
    /// Default configuration supplied with the installed Workx package.
    ...
    /// User config layer from $WORKX_HOME/config.toml. This layer is special
    ...
    /// Path to a .workx/ folder within a project. There could be multiple of

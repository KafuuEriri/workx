...
use workx_protocol::protocol::MisalignmentErrorDetails as CoreMisalignmentErrorDetails;
use workx_protocol::protocol::MisalignmentSteer as CoreMisalignmentSteer;
use workx_protocol::protocol::SessionSource as CoreSessionSource;
use workx_protocol::protocol::SubAgentSource as CoreSubAgentSource;
use workx_protocol::protocol::ThreadHistoryMode as CoreThreadHistoryMode;
...
#[ts(export_to = "v2/")]
pub struct Thread {
    /// Identifier for this thread. Workx-generated thread IDs are UUIDv7.
    pub id: String,
    ...
    /// Origin of the thread (CLI, VSCode, workx exec, workx app-server, etc.).
...
#[ts(export_to = "v2/")]
pub struct Turn {
    /// Identifier for this turn. Workx-generated turn IDs are UUIDv7.
    pub id: String,

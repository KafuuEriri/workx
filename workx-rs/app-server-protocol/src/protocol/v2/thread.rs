...
use workx_protocol::protocol::ThreadGoalStatus as CoreThreadGoalStatus;
use workx_protocol::protocol::TokenUsage as CoreTokenUsage;
use workx_protocol::protocol::TokenUsageInfo as CoreTokenUsageInfo;
...
pub struct ThreadStartParams {
    ...
    #[serde(
        default,
        deserialize_with = "workx_protocol::dynamic_tools::deserialize_dynamic_tool_specs"
    )]
    #[ts(optional = nullable)]
    ...
    /// This is for internal use only (e.g. Workx Cloud).
...
pub struct ThreadResumeParams {
    ...
    /// [UNSTABLE] FOR WORKX CLOUD - DO NOT USE.
...
impl From<workx_protocol::protocol::ThreadGoal> for ThreadGoal {
    fn from(value: workx_protocol::protocol::ThreadGoal) -> Self {
        Self {
...
impl ThreadMemoryMode {
    ...
    pub fn to_core(self) -> workx_protocol::protocol::ThreadMemoryMode {
        match self {
            Self::Enabled => workx_protocol::protocol::ThreadMemoryMode::Enabled,
            Self::Disabled => workx_protocol::protocol::ThreadMemoryMode::Disabled,
        }
    }
}
...
pub struct ThreadApproveGuardianDeniedActionParams {
    pub thread_id: String,
    /// Serialized `workx_protocol::protocol::GuardianAssessmentEvent`.
    pub event: JsonValue,
}
...
impl From<workx_protocol::ResponseUsageMetadata> for ResponseUsageMetadata {
    fn from(value: workx_protocol::ResponseUsageMetadata) -> Self {
        Self {
            amount: value.amount,

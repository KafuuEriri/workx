...
use workx_protocol::plan_tool::PlanItemArg as CorePlanItemArg;
use workx_protocol::plan_tool::StepStatus as CorePlanStepStatus;
use workx_protocol::turn_input::CyberAccessProgram as CoreCyberAccessProgram;
use workx_protocol::user_input::ByteRange as CoreByteRange;
use workx_protocol::user_input::TextElement as CoreTextElement;
...
/// Requested cyber treatment for a ChatGPT-authenticated Workx turn.
...
pub struct TurnStartParams {
    ...
    /// Optional metadata to enrich Workx's ResponsesAPI turn metadata.
    ///

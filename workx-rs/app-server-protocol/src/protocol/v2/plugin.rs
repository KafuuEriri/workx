...
use workx_protocol::protocol::SkillDependencies as CoreSkillDependencies;
use workx_protocol::protocol::SkillInterface as CoreSkillInterface;
use workx_protocol::protocol::SkillMetadata as CoreSkillMetadata;
use workx_protocol::protocol::SkillScope as CoreSkillScope;
use workx_protocol::protocol::SkillToolDependency as CoreSkillToolDependency;
...
pub enum PluginAvailability {
    ...
    /// Workx app-server exposes `"AVAILABLE"` in its API; the alias keeps

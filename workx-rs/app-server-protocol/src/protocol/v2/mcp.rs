...
use workx_protocol::items::McpToolCallError as CoreMcpToolCallError;
use workx_protocol::mcp::CallToolResult as CoreMcpCallToolResult;
use workx_protocol::mcp::McpServerInfo;
use workx_protocol::mcp::Resource as McpResource;
pub use workx_protocol::mcp::ResourceContent as McpResourceContent;
use workx_protocol::mcp::ResourceTemplate as McpResourceTemplate;
use workx_protocol::mcp::Tool as McpTool;

v2_enum_from_core!(
    pub enum McpAuthStatus from workx_protocol::protocol::McpAuthStatus {
        Unknown,
        Unsupported,
        NotLoggedIn,
        BearerToken,
...
v2_enum_from_core!(
    pub enum McpServerStartupFailureReason from workx_protocol::protocol::McpStartupFailureReason {
...
v2_enum_from_core!(
    ...
    pub enum McpServerConnectionStatus from workx_protocol::mcp::McpServerConnectionStatus {
        NotStarted,
        Starting,
        Connected,
...
impl McpServerElicitationAction {
    pub fn to_core(self) -> workx_protocol::approvals::ElicitationAction {
        match self {
            Self::Accept => workx_protocol::approvals::ElicitationAction::Accept,
            Self::Decline => workx_protocol::approvals::ElicitationAction::Decline,
            Self::Cancel => workx_protocol::approvals::ElicitationAction::Cancel,
        }
    }
}
...
pub struct McpServerElicitationRequestParams {
    pub thread_id: String,
    /// Active Workx turn when this elicitation was observed, if app-server could correlate one.
    ///

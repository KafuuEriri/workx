...
use serde::Serialize;
use workx_protocol::protocol::HookEventName as CoreHookEventName;
use workx_protocol::protocol::HookExecutionMode as CoreHookExecutionMode;
use workx_protocol::protocol::HookHandlerType as CoreHookHandlerType;
use workx_protocol::protocol::HookOutputEntry as CoreHookOutputEntry;
use workx_protocol::protocol::HookOutputEntryKind as CoreHookOutputEntryKind;
use workx_protocol::protocol::HookRunStatus as CoreHookRunStatus;
use workx_protocol::protocol::HookRunSummary as CoreHookRunSummary;
use workx_protocol::protocol::HookScope as CoreHookScope;
use workx_protocol::protocol::HookSource as CoreHookSource;
use workx_protocol::protocol::HookTrustStatus as CoreHookTrustStatus;

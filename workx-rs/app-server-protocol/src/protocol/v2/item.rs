...
use workx_experimental_api_macros::ExperimentalApi;
use workx_extension_items::ExtensionItem;
pub use workx_extension_items::image_generation::ImageGenerationFailure;
pub use workx_extension_items::image_generation::ImageGenerationItem;
pub use workx_extension_items::sleep::SleepItem;
pub use workx_extension_items::web_search::WebSearchAction;
pub use workx_extension_items::web_search::WebSearchItem;
use workx_protocol::approvals::ExecApprovalKind as CoreExecApprovalKind;
use workx_protocol::approvals::GuardianAssessmentAction as CoreGuardianAssessmentAction;
use workx_protocol::approvals::GuardianAssessmentDecisionSource as CoreGuardianAssessmentDecisionSource;
use workx_protocol::approvals::GuardianCommandSource as CoreGuardianCommandSource;
use workx_protocol::items::AgentMessageContent as CoreAgentMessageContent;
pub use workx_protocol::items::AgentMessageDelivery;
pub use workx_protocol::items::AsyncUserInputQuestion;
...
use workx_protocol::parse_command::ParsedCommand as CoreParsedCommand;
...
use workx_protocol::protocol::GuardianRiskLevel as CoreGuardianRiskLevel;
use workx_protocol::protocol::GuardianUserAuthorization as CoreGuardianUserAuthorization;
use workx_protocol::protocol::PatchApplyStatus as CorePatchApplyStatus;
use workx_protocol::protocol::ReviewDecision as CoreReviewDecision;
...
pub(crate) fn web_search_action_from_core(
    value: workx_protocol::models::WebSearchAction,
) -> WebSearchAction {
    match value {
        workx_protocol::models::WebSearchAction::Search { query, queries } => {
            WebSearchAction::Search { query, queries }
        }
        workx_protocol::models::WebSearchAction::OpenPage { url } => {
            WebSearchAction::OpenPage { url }
        }
        workx_protocol::models::WebSearchAction::FindInPage { url, pattern } => {
            WebSearchAction::FindInPage { url, pattern }
        }
        workx_protocol::models::WebSearchAction::Other => WebSearchAction::Other,
    }
}
...
impl From<workx_protocol::items::HookPromptFragment> for HookPromptFragment {
    fn from(value: workx_protocol::items::HookPromptFragment) -> Self {
        Self {
            text: value.text,
...
impl From<workx_protocol::dynamic_tools::DynamicToolCallOutputContentItem>
    for DynamicToolCallOutputContentItem
{
    fn from(item: workx_protocol::dynamic_tools::DynamicToolCallOutputContentItem) -> Self {
        match item {
...
impl From<DynamicToolCallOutputContentItem>
    for workx_protocol::dynamic_tools::DynamicToolCallOutputContentItem
{

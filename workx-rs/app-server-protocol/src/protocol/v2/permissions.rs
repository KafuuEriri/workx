...
use std::path::Path;
use workx_protocol::approvals::ExecPolicyAmendment as CoreExecPolicyAmendment;
use workx_protocol::approvals::NetworkApprovalContext as CoreNetworkApprovalContext;
use workx_protocol::approvals::NetworkApprovalProtocol as CoreNetworkApprovalProtocol;
use workx_protocol::approvals::NetworkPolicyAmendment as CoreNetworkPolicyAmendment;
use workx_protocol::approvals::NetworkPolicyRuleAction as CoreNetworkPolicyRuleAction;
use workx_protocol::models::ActivePermissionProfile as CoreActivePermissionProfile;
...
use workx_protocol::models::LegacyReadWriteRoots;
...
impl SandboxPolicy {
    pub fn to_core(&self) -> workx_protocol::protocol::SandboxPolicy {
        match self {
...
impl From<workx_protocol::protocol::SandboxPolicy> for SandboxPolicy {
    fn from(value: workx_protocol::protocol::SandboxPolicy) -> Self {
        match value {
            workx_protocol::protocol::SandboxPolicy::DangerFullAccess => {
                SandboxPolicy::DangerFullAccess
            }
            workx_protocol::protocol::SandboxPolicy::ReadOnly { network_access } => {
                SandboxPolicy::ReadOnly { network_access }
            }
            workx_protocol::protocol::SandboxPolicy::ExternalSandbox { network_access } => {

...
export type LoginAccountParams = { "type": "apiKey", apiKey: string, } | { "type": "chatgpt", workxStreamlinedLogin?: boolean, useHostedLoginSuccessPage?: boolean, appBrand?: LoginAppBrand | null, } | { "type": "chatgptDeviceCode" } | { "type": "chatgptAuthTokens",
/**

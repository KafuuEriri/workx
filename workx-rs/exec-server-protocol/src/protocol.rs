...
pub use workx_file_system::WalkOptions;
pub use workx_file_system::WalkOutcome;
...
use workx_shell_command::shell_detect::DetectedShell;
...
impl EnvironmentInfo {
    ...
    pub fn local() -> Self {
        ...
        Self {
            shell: workx_shell_command::shell_detect::default_user_shell().into(),
...
pub struct ExecParams {
    ...
    #[serde(default)]
    pub pipe_stdin: bool,
    /// Optional process-visible argv0 override. Values such as `workx-linux-sandbox` are command
...
mod tests {
    ...
    use workx_network_proxy::RemoteNetworkProxyLaunchConfig;
    use workx_protocol::config_types::WindowsSandboxProxySettingsMode;

...
/// Provenance for one layer in the effective Workx configuration.
...
pub enum ConfigLayerSource {
    ...
    /// Configuration loaded from a project's `.workx` directory.
    Project { dot_workx_folder: AbsolutePathBuf },
    ...
    match source {
        ...
        ConfigLayerSource::Project { dot_workx_folder } => {
            format!(
                ...
                dot_workx_folder.as_path().display()
            )
        }

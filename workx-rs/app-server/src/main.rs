...
use workx_app_server::AppServerCodeModeHostArgs;
use workx_app_server::AppServerRuntimeOptions;
use workx_app_server::AppServerTransport;
use workx_app_server::AppServerWebsocketAuthArgs;
...
const MANAGED_CONFIG_PATH_ENV_VAR: &str = "WORKX_APP_SERVER_MANAGED_CONFIG_PATH";
    ...
    arg0_dispatch_or_else(move |arg0_paths: Arg0DispatchPaths| async move {
        ...
        runtime_options.remote_control_startup_mode =
            match (remote_control, remote_control_disabled) {
                (true, _) => workx_app_server::RemoteControlStartupMode::EnabledEphemeral,
                (false, true) => workx_app_server::RemoteControlStartupMode::DisabledEphemeral,
                (false, false) => workx_app_server::RemoteControlStartupMode::ResolvePersisted,
            };

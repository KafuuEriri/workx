...
use workx_file_watcher::WatchRegistration;
...
pub(crate) struct PendingThreadResumeRequest {
    ...
    pub(crate) thread_summary: workx_app_server_protocol::Thread,
    ...
    pub(crate) initial_turns_page:
        Option<workx_app_server_protocol::ThreadResumeInitialTurnsPageParams>,
    pub(crate) paginated_turns: Option<Vec<Turn>>,
    pub(crate) paginated_initial_turns_page: Option<workx_app_server_protocol::TurnsPage>,
    pub(crate) paginated_initial_turns_page_with_active_slot:
        Option<workx_app_server_protocol::TurnsPage>,
    pub(crate) resume_cursor_store: Option<Arc<dyn workx_thread_store::ThreadStore>>,
...
pub(crate) struct ThreadState {
    ...
    listener_thread: Option<Weak<WorkxThread>>,
    watch_registration: WatchRegistration,
}

impl ThreadState {
    pub(crate) fn listener_matches(&self, conversation: &Arc<WorkxThread>) -> bool {

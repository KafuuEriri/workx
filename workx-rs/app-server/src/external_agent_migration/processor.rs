...
use workx_analytics::ExternalAgentConfigImportCompletedInput;
use workx_analytics::ExternalAgentConfigImportFailureInput;
...
use workx_app_server_protocol::ExternalAgentConfigImportHistoryRecordParams;
use workx_app_server_protocol::ExternalAgentConfigImportHistoryRecordResponse;
use workx_app_server_protocol::ExternalAgentConfigImportItemTypeFailure as ProtocolImportFailure;
use workx_app_server_protocol::ExternalAgentConfigImportItemTypeSuccess as ProtocolImportSuccess;
...
use workx_app_server_protocol::ExternalAgentConfigImportTypeResult as ProtocolImportTypeResult;
...
use workx_external_agent_migration::DetectedConnectorCandidate;
use workx_external_agent_migration::ExternalAgentConfigDetectOptions;
use workx_external_agent_migration::ExternalAgentConfigImportItemResult as CoreImportItemResult;
use workx_external_agent_migration::ExternalAgentConfigImportOutcome as CoreImportOutcome;
use workx_external_agent_migration::ExternalAgentConfigMigrationItemType as CoreMigrationItemType;
use workx_external_agent_migration::ExternalAgentConfigService;
use workx_external_agent_migration::ExternalAgentSessionImportLimits;
use workx_external_agent_migration::PluginImportOutcome;
use workx_external_agent_migration::record_import_error;
use workx_external_agent_migration::sessions::ExternalAgentSessionMigration as CoreSessionMigration;
use workx_external_agent_migration::sessions::read_imported_connector_candidates;
use workx_external_agent_migration::sessions::record_detected_session_connectors;
use workx_features::Feature;
use workx_rollout::StateDbHandle;
use workx_state::ExternalAgentConfigImportFailureRecord;
use workx_state::ExternalAgentConfigImportSuccessRecord;
...
impl ExternalAgentConfigRequestProcessor {
    ...
    pub(crate) async fn detect(
        ...
        record_detected_session_connectors(
            self.migration_service.workx_home(),
    ...
    pub(crate) async fn read_import_histories(
        ...
        let connectors = read_imported_connector_candidates(self.migration_service.workx_home())
            .map_err(|err| {
                internal_error(format!(

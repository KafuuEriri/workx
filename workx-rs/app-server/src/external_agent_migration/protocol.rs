...
use workx_app_server_protocol::CommandMigration;
...
use workx_app_server_protocol::ExternalAgentConfigImportHistory;
...
use workx_app_server_protocol::ExternalAgentDetectedConnectorCandidate;
use workx_app_server_protocol::ExternalAgentDetectedConnectorSource;
use workx_app_server_protocol::HookMigration;
use workx_app_server_protocol::JSONRPCErrorError;
use workx_app_server_protocol::McpServerMigration;
use workx_app_server_protocol::MigrationDetails;
use workx_app_server_protocol::PluginsMigration;
use workx_app_server_protocol::SkillMigration;
use workx_app_server_protocol::SubagentMigration;
use workx_external_agent_migration::DetectedConnectorCandidate as CoreDetectedConnectorCandidate;
use workx_external_agent_migration::DetectedConnectorSource as CoreDetectedConnectorSource;
use workx_external_agent_migration::ExternalAgentConfigImportItemResult as CoreImportItemResult;
use workx_external_agent_migration::ExternalAgentConfigImportRawError as CoreImportRawError;
use workx_external_agent_migration::ExternalAgentConfigImportSuccess;
use workx_external_agent_migration::ExternalAgentConfigMigrationItem as CoreMigrationItem;
use workx_external_agent_migration::ExternalAgentConfigMigrationItemType as CoreMigrationItemType;
use workx_external_agent_migration::MigrationDetails as CoreMigrationDetails;
use workx_external_agent_migration::NamedMigration;
use workx_external_agent_migration::PluginsMigration as CorePluginsMigration;
...
fn protocol_migration_details(details: CoreMigrationDetails) -> MigrationDetails {
    MigrationDetails {
        ...
        sessions: details
            .sessions
            .into_iter()
            .map(|session| workx_app_server_protocol::SessionMigration {
                path: session.path,
                cwd: session.cwd,
                title: session.title,
            })
...
pub(super) fn protocol_import_history(
    record: workx_state::ExternalAgentConfigImportHistoryRecord,

...
use workx_app_server_protocol::ChatgptAuthTokensRefreshParams;
...
use workx_login::auth::ExternalAuthRefreshReason;
...
pub(crate) struct ExternalAuthBridge {
    ...
    auth: RwLock<WorkxAuth>,
}

impl ExternalAuthBridge {
    pub(crate) fn new(outgoing: Arc<OutgoingMessageSender>, auth: WorkxAuth) -> Self {
        Self {
            outgoing,
    ...
    async fn refresh(&self, context: ExternalAuthRefreshContext) -> std::io::Result<WorkxAuth> {

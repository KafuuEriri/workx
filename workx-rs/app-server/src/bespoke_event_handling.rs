...
use tracing::error;
use workx_app_server_protocol::AccountRateLimitsUpdatedNotification;
use workx_app_server_protocol::AdditionalPermissionProfile as V2AdditionalPermissionProfile;
use workx_app_server_protocol::AuthRecoveryNotification;
use workx_app_server_protocol::CommandAction as V2ParsedCommand;
use workx_app_server_protocol::CommandExecutionApprovalDecision;
use workx_app_server_protocol::CommandExecutionPresentation;
...
use workx_app_server_protocol::DynamicToolCallParams;
use workx_app_server_protocol::EnvironmentConnectionNotification;
use workx_app_server_protocol::ErrorNotification;
use workx_app_server_protocol::ExecPolicyAmendment as V2ExecPolicyAmendment;
use workx_app_server_protocol::FileChangeApprovalDecision;
use workx_app_server_protocol::FileChangeRequestApprovalParams;
use workx_app_server_protocol::FileChangeRequestApprovalResponse;
use workx_app_server_protocol::GrantedPermissionProfile as V2GrantedPermissionProfile;
use workx_app_server_protocol::GuardianWarningNotification;
use workx_app_server_protocol::HookCompletedNotification;
use workx_app_server_protocol::HookStartedNotification;
use workx_app_server_protocol::ItemCompletedNotification;
use workx_app_server_protocol::ItemStartedNotification;
use workx_app_server_protocol::McpServerElicitationAction;
use workx_app_server_protocol::McpServerElicitationRequestParams;
use workx_app_server_protocol::McpServerElicitationRequestResponse;
use workx_app_server_protocol::McpServerStartupState;
use workx_app_server_protocol::McpServerStatusUpdatedNotification;
use workx_app_server_protocol::ModelReroutedNotification;
use workx_app_server_protocol::ModelSafetyBufferingUpdatedNotification;
use workx_app_server_protocol::ModelVerificationNotification;
use workx_app_server_protocol::NetworkApprovalContext as V2NetworkApprovalContext;
use workx_app_server_protocol::NetworkPolicyAmendment as V2NetworkPolicyAmendment;
use workx_app_server_protocol::NetworkPolicyRuleAction as V2NetworkPolicyRuleAction;
use workx_app_server_protocol::PermissionsRequestApprovalParams;
use workx_app_server_protocol::PermissionsRequestApprovalResponse;
use workx_app_server_protocol::RawResponseCompletedNotification;
use workx_app_server_protocol::RawResponseItemCompletedNotification;
use workx_app_server_protocol::RequestId;
use workx_app_server_protocol::ServerNotification;
use workx_app_server_protocol::ServerRequestPayload;
use workx_app_server_protocol::StrictReviewRequiredNotification;
use workx_app_server_protocol::ThreadGoalUpdatedNotification;
use workx_app_server_protocol::ThreadItem;
use workx_app_server_protocol::ThreadRealtimeClosedNotification;
use workx_app_server_protocol::ThreadRealtimeErrorNotification;
use workx_app_server_protocol::ThreadRealtimeItemAddedNotification;
use workx_app_server_protocol::ThreadRealtimeItemCompletedNotification;
use workx_app_server_protocol::ThreadRealtimeItemStartedNotification;
use workx_app_server_protocol::ThreadRealtimeItemTranscriptDeltaNotification;
use workx_app_server_protocol::ThreadRealtimeOutputAudioDeltaNotification;
use workx_app_server_protocol::ThreadRealtimeSdpNotification;
use workx_app_server_protocol::ThreadRealtimeStartedNotification;
use workx_app_server_protocol::ThreadRealtimeTranscriptDeltaNotification;
use workx_app_server_protocol::ThreadRealtimeTranscriptDoneNotification;
use workx_app_server_protocol::ThreadRollbackResponse;
use workx_app_server_protocol::ThreadSettingsUpdatedNotification;
use workx_app_server_protocol::ThreadStatus;
use workx_app_server_protocol::ThreadTokenUsage;
use workx_app_server_protocol::ThreadTokenUsageUpdatedNotification;
use workx_app_server_protocol::ToolRequestUserInputOption;
use workx_app_server_protocol::ToolRequestUserInputParams;
use workx_app_server_protocol::ToolRequestUserInputQuestion;
use workx_app_server_protocol::ToolRequestUserInputResponse;
...
use workx_app_server_protocol::TurnModerationMetadataNotification;
use workx_app_server_protocol::TurnPlanStep;
use workx_app_server_protocol::TurnPlanUpdatedNotification;
use workx_app_server_protocol::TurnStartedNotification;
use workx_app_server_protocol::TurnStatus;
use workx_app_server_protocol::WarningNotification;
use workx_app_server_protocol::WorkxErrorInfo as V2WorkxErrorInfo;
use workx_app_server_protocol::build_item_from_guardian_event;
use workx_app_server_protocol::guardian_auto_approval_review_notification;
use workx_app_server_protocol::item_event_to_server_notification;
use workx_core::ThreadManager;
use workx_core::WorkxThread;
use workx_features::Feature;
use workx_guardian_v2::StrictReviewReason;
use workx_protocol::ThreadId;
use workx_protocol::items::CollabAgentTool as CoreCollabAgentTool;
use workx_protocol::items::TurnItem as CoreTurnItem;
use workx_protocol::models::AdditionalPermissionProfile as CoreAdditionalPermissionProfile;
use workx_protocol::plan_tool::UpdatePlanArgs;
use workx_protocol::protocol::Event;
use workx_protocol::protocol::EventMsg;
use workx_protocol::protocol::ExecApprovalRequestEvent;
use workx_protocol::protocol::Op;
use workx_protocol::protocol::RealtimeEvent;
use workx_protocol::protocol::ReviewDecision;
use workx_protocol::protocol::SubAgentActivityKind;
...
use workx_protocol::protocol::TurnDiffEvent;
use workx_protocol::protocol::WorkxErrorInfo as CoreWorkxErrorInfo;
...
use workx_protocol::request_user_input::RequestUserInputAnswer as CoreRequestUserInputAnswer;
use workx_protocol::request_user_input::RequestUserInputResponse as CoreRequestUserInputResponse;
use workx_shell_command::parse_command::shlex_join;
    ...
    match msg {
        ...
        EventMsg::McpStartupUpdate(update) => {
            let (status, error, failure_reason) = match update.status {
                workx_protocol::protocol::McpStartupStatus::Starting => {
                    (McpServerStartupState::Starting, None, None)
                }
                workx_protocol::protocol::McpStartupStatus::Ready => {
                    (McpServerStartupState::Ready, None, None)
                }
                workx_protocol::protocol::McpStartupStatus::Failed { error, reason } => (
                    McpServerStartupState::Failed,
                    Some(error),
                    reason.map(Into::into),
                ),
                workx_protocol::protocol::McpStartupStatus::Cancelled => {
        ...
        EventMsg::GuardianAssessment(assessment) => {
            ...
            if assessment.status == workx_protocol::protocol::GuardianAssessmentStatus::InProgress
            ...
            let completion_status = match assessment.status {
                workx_protocol::protocol::GuardianAssessmentStatus::Denied
                | workx_protocol::protocol::GuardianAssessmentStatus::Aborted => {
                    Some(CommandExecutionStatus::Declined)
                }
                workx_protocol::protocol::GuardianAssessmentStatus::TimedOut => {
                    Some(CommandExecutionStatus::Failed)
                }
                workx_protocol::protocol::GuardianAssessmentStatus::InProgress
                | workx_protocol::protocol::GuardianAssessmentStatus::Approved => None,
            };
                ...
                Err(err) => {
                    ...
                    if let Err(err) = conversation
                        .submit(Op::ResolveElicitation {
                            ...
                            request_id: request.id,
                            decision: workx_protocol::approvals::ElicitationAction::Cancel,
                            content: None,
                            meta: None,
                        })
                        .await
        ...
        EventMsg::Error(ev) => {
            ...
            let workx_error_info = ev.workx_error_info.clone();
            ...
            if matches!(
                workx_error_info,
                Some(CoreWorkxErrorInfo::ThreadRollbackFailed)
            ) {
            ...
            let turn_error = TurnError {
                ...
                message: ev.message,
                workx_error_info: ev.workx_error_info.map(V2WorkxErrorInfo::from),
...
fn thread_rollback_response_from_stored_thread(
    stored_thread: workx_thread_store::StoredThread,
    session_id: String,
...
async fn on_mcp_server_elicitation_response(
    server_name: String,
    request_id: workx_protocol::mcp::RequestId,
    pending_request_id: RequestId,
    receiver: oneshot::Receiver<ClientRequestResult>,
    conversation: Arc<WorkxThread>,
    thread_state: Arc<Mutex<ThreadState>>,
...
fn request_permissions_response_from_client_result(
    ...
    let response = serde_json::from_value::<PermissionsRequestApprovalResponse>(value)
        .unwrap_or_else(|err| {
            ...
            PermissionsRequestApprovalResponse {
                ...
                scope: workx_app_server_protocol::PermissionGrantScope::Turn,
    ...
    if strict_auto_review
        && matches!(
            response.scope,
            workx_app_server_protocol::PermissionGrantScope::Session
        )
    {
...
mod tests {
    ...
    use tokio::sync::Mutex;
    use tokio::sync::mpsc;
    use workx_app_server_protocol::AutoReviewDecisionSource;
    ...
    use workx_app_server_protocol::TurnPlanStepStatus;
    use workx_login::WorkxAuth;
    use workx_protocol::AgentPath;
    use workx_protocol::items::AgentMessageContent as CoreAgentMessageContent;
    use workx_protocol::items::AgentMessageItem as CoreAgentMessageItem;
    use workx_protocol::items::DynamicToolCallItem;
    use workx_protocol::items::DynamicToolCallStatus as CoreDynamicToolCallStatus;
    use workx_protocol::items::SubAgentActivityItem;
    use workx_protocol::items::TurnItem as CoreTurnItem;
    use workx_protocol::models::FileSystemPermissions as CoreFileSystemPermissions;
    use workx_protocol::models::NetworkPermissions as CoreNetworkPermissions;
    use workx_protocol::models::PermissionProfile;
    use workx_protocol::plan_tool::PlanItemArg;
    use workx_protocol::plan_tool::StepStatus;
    use workx_protocol::protocol::AgentMessageEvent;
    use workx_protocol::protocol::AskForApproval;
    use workx_protocol::protocol::AuthRecoveryEvent;
    use workx_protocol::protocol::CreditsSnapshot;
    use workx_protocol::protocol::EventMsg;
    use workx_protocol::protocol::GuardianAssessmentEvent;
    use workx_protocol::protocol::GuardianAssessmentStatus;
    use workx_protocol::protocol::ItemCompletedEvent;
    use workx_protocol::protocol::ItemStartedEvent;
    ...
    use workx_thread_store::StoredThreadHistory;
    use workx_utils_absolute_path::AbsolutePathBuf;
    ...
    fn turn_aborted_event(turn_id: &str) -> TurnAbortedEvent {
        TurnAbortedEvent {
            ...
            started_at: None,
            reason: workx_protocol::protocol::TurnAbortReason::Interrupted,
            completed_at: Some(TEST_TURN_COMPLETED_AT),
            duration_ms: Some(TEST_TURN_DURATION_MS),
        }
    }
    ...
    fn guardian_command_assessment(
        ...
        let (risk_level, user_authorization, rationale) = match status {
            ...
            GuardianAssessmentStatus::Approved => (
                Some(workx_protocol::protocol::GuardianRiskLevel::Low),
                Some(workx_protocol::protocol::GuardianUserAuthorization::High),
                Some("looks safe".to_string()),
            ),
            GuardianAssessmentStatus::Denied => (
                Some(workx_protocol::protocol::GuardianRiskLevel::High),
                Some(workx_protocol::protocol::GuardianUserAuthorization::Low),
        ...
        GuardianAssessmentEvent {
            ...
            decision_source: if matches!(status, GuardianAssessmentStatus::InProgress) {
                ...
                Some(workx_protocol::protocol::GuardianAssessmentDecisionSource::Agent)
            },
    ...
    fn guardian_assessment_started_uses_event_turn_id_fallback() {
        ...
        let action = workx_protocol::protocol::GuardianAssessmentAction::Command {
            source: workx_protocol::protocol::GuardianCommandSource::Shell,
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                ...
                status: workx_protocol::protocol::GuardianAssessmentStatus::InProgress,
                risk_level: None,
    ...
    fn guardian_assessment_completed_emits_review_payload() {
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                ...
                status: workx_protocol::protocol::GuardianAssessmentStatus::Denied,
                risk_level: Some(workx_protocol::protocol::GuardianRiskLevel::High),
                user_authorization: Some(workx_protocol::protocol::GuardianUserAuthorization::Low),
                rationale: Some("too risky".to_string()),
                decision_source: Some(
                    workx_protocol::protocol::GuardianAssessmentDecisionSource::Agent,
                ),
                action: action.clone(),
            },
        );
        ...
        match notification {
            ServerNotification::ItemGuardianApprovalReviewCompleted(payload) => {
                ...
                assert_eq!(
                    ...
                    Some(workx_app_server_protocol::GuardianRiskLevel::High)
                );
                assert_eq!(
                    payload.review.user_authorization,
                    Some(workx_app_server_protocol::GuardianUserAuthorization::Low)
                );
    ...
    fn guardian_assessment_aborted_emits_completed_review_payload() {
        let conversation_id = ThreadId::new();
        let action = workx_protocol::protocol::GuardianAssessmentAction::NetworkAccess {
            target: "api.openai.com:443".to_string(),
            host: "api.openai.com".to_string(),
            protocol: workx_protocol::protocol::NetworkApprovalProtocol::Https,
            port: 443,
        };
        let notification = guardian_auto_approval_review_notification(
            &conversation_id,
            ...
            &GuardianAssessmentEvent {
                ...
                started_at_ms: 1_000,
                completed_at_ms: Some(1_042),
                status: workx_protocol::protocol::GuardianAssessmentStatus::Aborted,
                risk_level: None,
                user_authorization: None,
                rationale: None,
                decision_source: Some(
    ...
    async fn command_execution_started_helper_emits_once() -> Result<()> {
        ...
        let outgoing = Arc::new(OutgoingMessageSender::new(
            tx,
            workx_analytics::AnalyticsEventsClient::disabled(),
        ));
    ...
    async fn guardian_command_execution_notifications_wrap_review_lifecycle() -> Result<()> {
        ...
        let config = load_default_config_for_test(&workx_home).await;
        let thread_manager = Arc::new(
            workx_core::test_support::thread_manager_with_models_provider_and_home(
                WorkxAuth::create_dummy_chatgpt_auth_for_testing(),
                config.model_provider.clone(),
                config.workx_home.to_path_buf(),
                Arc::new(workx_exec_server::EnvironmentManager::default_for_tests()),
            ),
        );
        let workx_core::NewThread {
            thread_id: conversation_id,
            thread: conversation,
            ..
        } = thread_manager
            .start_thread(workx_core::StartThreadOptions::new(config.clone()))
            .await?;
        let thread_state = new_thread_state();
    ...
    async fn test_handle_error_records_message() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                workx_error_info: Some(V2WorkxErrorInfo::InternalServerError),
                additional_details: None,
            },
            &thread_state,
        )
    ...
    async fn turn_started_omits_active_snapshot_items() -> Result<()> {
        ...
        let thread_state = new_thread_state();
        {
            ...
            state.track_current_turn_event(
                "turn-1",
                &EventMsg::TurnStarted(workx_protocol::protocol::TurnStartedEvent {
            ...
            state.track_current_turn_event(
                "turn-1",
                &EventMsg::UserMessage(workx_protocol::protocol::UserMessageEvent {
                    client_id: None,
        ...
        apply_bespoke_event_handling(
            Event {
                id: "turn-1".to_string(),
                msg: EventMsg::TurnStarted(workx_protocol::protocol::TurnStartedEvent {
                    turn_id: "turn-1".to_string(),
                    trace_id: None,
                    started_at: Some(42),
                    model_context_window: None,
    ...
    async fn interrupted_subagent_activity_removes_missing_thread_watch() -> Result<()> {
        ...
        let workx_core::NewThread {
            ...
            .start_thread(workx_core::StartThreadOptions::new(config))
            .await?;
        ...
        assert_eq!(
            ...
            ItemCompletedNotification {
                item: ThreadItem::SubAgentActivity {
                    id: "activity-1".to_string(),
                    kind: workx_app_server_protocol::SubAgentActivityKind::Interrupted,
    ...
    async fn test_handle_turn_complete_emits_failed_with_error() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                workx_error_info: Some(V2WorkxErrorInfo::Other),
                additional_details: None,
            },
            &thread_state,
        )
    ...
    async fn test_handle_token_count_event_emits_usage_and_rate_limits() -> Result<()> {
        ...
        match second {
            ServerNotification::AccountRateLimitsUpdated(payload) => {
                assert_eq!(payload.rate_limits.limit_id.as_deref(), Some("workx"));
    ...
    async fn test_handle_turn_complete_emits_error_multiple_turns() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                workx_error_info: Some(V2WorkxErrorInfo::BadRequest),
                additional_details: None,
            },
            &thread_state,
        )

    ...
    route_outgoing_envelope(
        ...
        OutgoingEnvelope::ToConnection {
            ...
            message: OutgoingMessage::Request(ServerRequest::CommandExecutionRequestApproval {
                ...
                params: workx_app_server_protocol::CommandExecutionRequestApprovalParams {
                    ...
                    additional_permissions: Some(
                        workx_app_server_protocol::AdditionalPermissionProfile {
                            network: None,
                            file_system: Some(
                                workx_app_server_protocol::AdditionalFileSystemPermissions {

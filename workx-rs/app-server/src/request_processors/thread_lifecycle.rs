...
pub(super) async fn wait_for_thread_shutdown(thread: &Arc<WorkxThread>) -> ThreadShutdownResult {
...
fn merge_active_turn_into_page(
    page: &mut workx_app_server_protocol::TurnsPage,
    mut active_turn: Turn,
    params: &workx_app_server_protocol::ThreadResumeInitialTurnsPageParams,
) {

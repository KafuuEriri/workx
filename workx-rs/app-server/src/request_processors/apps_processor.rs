...
impl AppsRequestProcessor {
    ...
    async fn apps_list_task(
        ...
        let should_retry = result
            .as_ref()
            .is_ok_and(|(_, workx_apps_ready)| !workx_apps_ready);
        outgoing
        ...
        if should_retry && !retry_params.force_refetch {
            ...
            .await
            {
                warn!("failed to refresh app list after workx-apps readiness retry: {err:?}");
            }
        }
    }
        ...
        loop {
            ...
            match result {
                AppListLoadResult::Accessible(Ok(status)) => {
                    ...
                    workx_apps_ready = status.workx_apps_ready;
                }
            ...
            if accessible_loaded && all_loaded {
                ...
                return Ok((response, workx_apps_ready));
            }
        }
    }
...
const APPS_INSTALLED_DURATION_METRIC: &str = "workx.apps.installed.duration_ms";

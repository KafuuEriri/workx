...
use workx_login::default_client::SetOriginatorError;
...
const NON_ORIGINATING_CLIENT_NAMES: &[&str] = &["workx_app_server_daemon", "workx-backend"];
...
impl InitializeRequestProcessor {
    ...
    pub(crate) async fn initialize(
        ...
        let client_mcp_extensions = workx_mcp::client_mcp_extensions(
            extensions,
            ...
            if let Err(error) = set_default_originator(originator.clone()) {
                match error {
                    ...
                    SetOriginatorError::AlreadyInitialized => {
                        ...
                        // TODO(owen): Once we remove support for WORKX_INTERNAL_ORIGINATOR_OVERRIDE,

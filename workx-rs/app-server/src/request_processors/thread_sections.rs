...
use workx_thread_store::CreateThreadSectionParams as StoreCreateThreadSectionParams;
use workx_thread_store::DeleteThreadSectionParams as StoreDeleteThreadSectionParams;
use workx_thread_store::ListThreadSectionsParams as StoreListThreadSectionsParams;
use workx_thread_store::RenameThreadSectionParams as StoreRenameThreadSectionParams;
use workx_thread_store::StoredThreadSection;
...
fn state_thread_section_appearance(
    appearance: ThreadSectionAppearance,
) -> workx_state::ThreadSectionAppearance {
    workx_state::ThreadSectionAppearance {
        icon: appearance.icon,
        color: appearance.color,
    }

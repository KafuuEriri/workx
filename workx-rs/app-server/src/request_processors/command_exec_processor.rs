use super::*;
use workx_core::exec_env::inject_apply_patch_env;
...
impl CommandExecRequestProcessor {
    ...
    async fn exec_one_off_command_inner(
        ...
        let workx_linux_sandbox_exe = self.arg0_paths.workx_linux_sandbox_exe.clone();
        ...
        let exec_request = workx_core::exec::build_exec_request(
            exec_params,
            &effective_permission_profile,
            &sandbox_cwd,

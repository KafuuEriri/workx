...
use workx_app_server_protocol::AwsCredentialType;
use workx_app_server_protocol::BedrockAwsProfile;
use workx_app_server_protocol::BedrockDiscoverParams;
use workx_app_server_protocol::BedrockDiscoverResponse;
use workx_app_server_protocol::BedrockEnvironmentCredential;
...
impl AccountRequestProcessor {
    pub(crate) async fn bedrock_discover(
        ...
        let profiles = workx_aws_auth::discover_aws_profiles()
            .await
    ...
    pub(crate) async fn bedrock_setup(
        ...
        let profile = match &params {
            BedrockSetupParams::Profile { profile, .. } => {
                ...
                workx_aws_auth::validate_aws_profile(profile, region)
                    .await
                    .map_err(|err| {

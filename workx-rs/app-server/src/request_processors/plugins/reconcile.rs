...
use workx_app_server_protocol::PluginReconcileParams;
use workx_app_server_protocol::PluginReconcileResponse;
use workx_core_plugins::remote::RemotePluginShareDiscoverability;
...
impl PluginRequestProcessor {
    ...
    pub(crate) async fn plugin_reconcile(
        ...
        if !plugins_input.plugins_enabled
            || !auth.as_ref().is_some_and(WorkxAuth::uses_workx_backend)
        {

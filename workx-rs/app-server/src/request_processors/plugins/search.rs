...
use workx_app_server_protocol::PluginSearchResult;
use workx_app_server_protocol::PluginSearchScope;
use workx_core_plugins::OPENAI_BUNDLED_MARKETPLACE_NAME;
use workx_core_plugins::remote::RemotePluginSearchRequest;
use workx_core_plugins::remote::search_remote_plugins;
...
impl PluginRequestProcessor {
    ...
    async fn plugin_search_response(
        ...
        let use_remote_global_catalog =
            remote_plugin_enabled && auth_mode.is_some_and(DomainAuthMode::uses_workx_backend);
        ...
        if auth_mode.is_some_and(DomainAuthMode::uses_workx_backend)

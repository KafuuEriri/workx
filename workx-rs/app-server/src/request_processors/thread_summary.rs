...
fn extract_conversation_summary(
    ...
    let preview = head
        ...
        .find_map(|item| match workx_core::parse_turn_item(&item) {
...
pub(super) fn with_thread_spawn_agent_metadata(
    source: workx_protocol::protocol::SessionSource,
    agent_nickname: Option<String>,
    agent_role: Option<String>,
) -> workx_protocol::protocol::SessionSource {
    if agent_nickname.is_none() && agent_role.is_none() {
        return source;
    }

    match source {
        workx_protocol::protocol::SessionSource::SubAgent(
...
) -> Option<workx_app_server_protocol::ActivePermissionProfile> {

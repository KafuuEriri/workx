use workx_app_server_protocol::AppBranding as ApiAppBranding;
use workx_app_server_protocol::AppInfo as ApiAppInfo;
use workx_app_server_protocol::AppMetadata as ApiAppMetadata;
use workx_app_server_protocol::AppReview as ApiAppReview;
use workx_app_server_protocol::AppScreenshot as ApiAppScreenshot;
use workx_app_server_protocol::AppToolSummary as ApiAppToolSummary;
use workx_app_server_protocol::ConnectorMetadata as ApiConnectorMetadata;
use workx_connectors::AppBranding;
use workx_connectors::AppInfo;
use workx_connectors::AppMetadata;
use workx_connectors::AppReview;
use workx_connectors::AppScreenshot;
...
/// Converts connector-domain app metadata owned by `workx-connectors` into the app-server wire
/// type owned by `workx-app-server-protocol`.
///

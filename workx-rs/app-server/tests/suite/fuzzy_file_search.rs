...
use workx_app_server_protocol::FuzzyFileSearchSessionCompletedNotification;
use workx_app_server_protocol::FuzzyFileSearchSessionUpdatedNotification;
...
async fn test_fuzzy_file_search_sorts_and_includes_indices() -> Result<()> {
    // Prepare a temporary Workx home and a separate root with test files.

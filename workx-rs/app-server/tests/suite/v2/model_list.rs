...
use workx_app_server_protocol::Model;
use workx_app_server_protocol::ModelListParams;
use workx_app_server_protocol::ModelListResponse;
use workx_app_server_protocol::ModelServiceTier;
use workx_app_server_protocol::ModelUpgradeInfo;
use workx_app_server_protocol::ReasoningEffortOption;
...
fn expected_visible_models() -> Vec<Model> {
    ...
    let mut presets = ModelPreset::filter_by_auth(
        workx_core::test_support::all_model_presets().clone(),
        /*chatgpt_mode*/ false,
    );

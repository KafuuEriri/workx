...
use workx_app_server_protocol::ServerDiagnosticsGauge;
use workx_app_server_protocol::ServerDiagnosticsParams;
use workx_app_server_protocol::ServerDiagnosticsResponse;

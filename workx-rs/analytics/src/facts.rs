...
pub use workx_protocol::error::WorkxErrKind;
...
/// Measurements for one successfully decoded image at the point where Workx prepares it for
...
#[derive(Clone)]
pub struct TurnWorkxErrorFact {
    pub(crate) turn_id: String,
    pub(crate) thread_id: String,
    pub(crate) error: TurnWorkxError,
}

impl TurnWorkxErrorFact {
    pub fn from_workx_err(thread_id: String, turn_id: String, error: &WorkxErr) -> Self {
        Self {
            turn_id,
            thread_id,
            error: TurnWorkxError::from_workx_err(error),
        }
    }
}

#[derive(Clone)]
pub(crate) struct TurnWorkxError {
    pub(crate) kind: WorkxErrKind,
    pub(crate) http_status_code: Option<u16>,
}

impl TurnWorkxError {
    fn from_workx_err(error: &WorkxErr) -> Self {
        Self {
            kind: error.into(),
...
#[derive(Clone)]
pub struct WorkxTurnSteerEvent {
...
#[derive(Clone)]
pub struct WorkxCompactionEvent {
    pub thread_id: String,
    pub turn_id: String,
    ...
    pub workx_error_kind: Option<WorkxErrKind>,
    pub workx_error_http_status_code: Option<u16>,
...
#[derive(Clone)]
pub struct WorkxGoalEvent {
    pub thread_id: String,
    pub turn_id: Option<String>,
    pub goal_id: String,
    pub event_kind: GoalEventKind,
    pub goal_status: workx_state::ThreadGoalStatus,
...
pub(crate) enum CustomAnalyticsFact {
    ...
    Compaction(Box<WorkxCompactionEvent>),
    Goal(Box<WorkxGoalEvent>),
    GuardianReview(Box<GuardianReviewEventParams>),
    GuardianV2(Box<GuardianV2Event>),
    TurnResolvedConfig(Box<TurnResolvedConfigFact>),
    TurnTokenUsage(Box<TurnTokenUsageFact>),
    TurnProfile(Box<TurnProfileFact>),
    TurnWorkxError(Box<TurnWorkxErrorFact>),

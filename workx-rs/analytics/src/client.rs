...
use workx_protocol::items::CollabAgentToolCallStatus;
...
impl AnalyticsEventsDestination {
    ...
    fn from_base_url_and_capture_file(base_url: String, capture_file: Option<PathBuf>) -> Self {
        ...
        Self::Http {
            url: format!("{base_url}/workx/analytics-events/events"),
        }
    }
}
...
impl AnalyticsEventsClient {
    ...
    pub fn track_compaction(&self, event: crate::facts::WorkxCompactionEvent) {
    ...
    pub fn track_goal_event(&self, event: WorkxGoalEvent) {
    ...
    pub fn track_turn_workx_error(&self, fact: TurnWorkxErrorFact) {
        self.record_fact(AnalyticsFact::Custom(CustomAnalyticsFact::TurnWorkxError(
            Box::new(fact),
        )));
    }
...
async fn send_track_events(
    ...
    } else if !auth.uses_workx_backend() {
        return;
    }
    if events.is_empty() {
        return;

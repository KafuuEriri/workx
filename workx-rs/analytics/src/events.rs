...
use workx_protocol::models::SandboxPermissions;
use workx_protocol::protocol::GuardianAssessmentOutcome;
use workx_protocol::protocol::GuardianCommandSource;
use workx_protocol::protocol::GuardianRiskLevel;
use workx_protocol::protocol::GuardianUserAuthorization;
...
pub(crate) enum TrackEventRequest {
    ...
    AppMentioned(WorkxAppMentionedEventRequest),
    AppUsed(WorkxAppUsedEventRequest),
    HookRun(WorkxHookRunEventRequest),
    Compaction(Box<WorkxCompactionEventRequest>),
    Goal(Box<WorkxGoalEventRequest>),
    TurnEvent(Box<WorkxTurnEventRequest>),
    TurnSteer(WorkxTurnSteerEventRequest),
    ArtifactOperation(WorkxArtifactOperationEventRequest),
    CommandExecution(WorkxCommandExecutionEventRequest),
    PluginMeasurement(WorkxPluginMeasurementEventRequest),
    FileChange(WorkxFileChangeEventRequest),
    McpToolCall(WorkxMcpToolCallEventRequest),
    DynamicToolCall(WorkxDynamicToolCallEventRequest),
    ControlToolCall(WorkxControlToolCallEventRequest),
    CollabAgentToolCall(WorkxCollabAgentToolCallEventRequest),
    WebSearch(WorkxWebSearchEventRequest),
    ImageGeneration(WorkxImageGenerationEventRequest),
    AcceptedLineFingerprints(Box<WorkxAcceptedLineFingerprintsEventRequest>),
    #[allow(dead_code)]
    ReviewEvent(WorkxReviewEventRequest),
    PluginUsed(WorkxPluginUsedEventRequest),
    PluginInstallRequested(WorkxPluginInstallRequestedEventRequest),
    PluginInstalled(WorkxPluginEventRequest),
    PluginUninstalled(WorkxPluginEventRequest),
    PluginEnabled(WorkxPluginEventRequest),
    PluginDisabled(WorkxPluginEventRequest),
    PluginInstallFailed(WorkxPluginInstallFailedEventRequest),
    ExternalAgentConfigImportCompleted(WorkxOnboardingExternalAgentImportCompleteEventRequest),
    ExternalAgentConfigImportFailure(WorkxOnboardingExternalAgentImportFailureEventRequest),
}

#[derive(Serialize)]
pub(crate) struct WorkxArtifactOperationEventParams {
    ...
    pub(crate) runtime: WorkxRuntimeMetadata,
...
#[derive(Serialize)]
pub(crate) struct WorkxArtifactOperationEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: WorkxArtifactOperationEventParams,
}

pub(crate) fn workx_artifact_operation_event_request(
    tracking: TrackEventsContext,
    operation: ArtifactOperation,
) -> WorkxArtifactOperationEventRequest {
    WorkxArtifactOperationEventRequest {
        event_type: "workx_artifact_operation",
        event_params: WorkxArtifactOperationEventParams {
...
#[derive(Serialize)]
pub(crate) struct WorkxAcceptedLineFingerprintsEventParams {
    pub(crate) event_type: &'static str,
    pub(crate) turn_id: String,
    pub(crate) thread_id: String,
...
#[derive(Serialize)]
pub(crate) struct WorkxAcceptedLineFingerprintsEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: WorkxAcceptedLineFingerprintsEventParams,
}
...
pub(crate) struct WorkxAppServerClientMetadata {
    pub(crate) product_client_id: String,
...
#[derive(Clone, Serialize)]
pub(crate) struct WorkxRuntimeMetadata {
    pub(crate) workx_rs_version: String,
...
pub(crate) struct ThreadInitializedEventParams {
    ...
    pub(crate) app_server_client: WorkxAppServerClientMetadata,
    pub(crate) runtime: WorkxRuntimeMetadata,
...
pub(crate) struct ThreadArchiveEventParams {
    ...
    pub(crate) app_server_client: Option<WorkxAppServerClientMetadata>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub(crate) runtime: Option<WorkxRuntimeMetadata>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub(crate) thread_source: Option<ThreadSource>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub(crate) parent_thread_id: Option<String>,
...
pub enum GuardianApprovalRequestSource {
    /// Approval requested directly by the main Workx turn.
    MainTurn,
...
#[derive(Serialize)]
pub(crate) struct WorkxToolItemEventBase {
    pub(crate) thread_id: String,
    pub(crate) session_id: String,
    pub(crate) turn_id: String,
...
#[derive(Serialize)]
pub(crate) struct WorkxReviewEventParams {
    pub(crate) thread_id: String,
    pub(crate) turn_id: String,
...
#[derive(Serialize)]
pub(crate) struct WorkxReviewEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: WorkxReviewEventParams,
}
#[allow(dead_code)]
#[derive(Clone, Copy, Debug, Serialize)]
#[serde(rename_all = "snake_case")]
...
#[derive(Serialize)]
pub(crate) struct WorkxCommandExecutionEventParams {
    #[serde(flatten)]
    pub(crate) base: WorkxToolItemEventBase,
    pub(crate) plugin_id: Option<String>,
...
#[derive(Serialize)]
pub(crate) struct WorkxCommandExecutionEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: WorkxCommandExecutionEventParams,
}

#[derive(Serialize)]
pub(crate) struct WorkxPluginMeasurementEventParams {
    pub(crate) thread_id: String,
    pub(crate) turn_id: String,
    pub(crate) item_id: String,
    pub(crate) plugin_id: String,
...
#[derive(Serialize)]
pub(crate) struct WorkxPluginMeasurementEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: WorkxPluginMeasurementEventParams,
}

#[derive(Serialize)]
pub(crate) struct WorkxFileChangeEventParams {
    #[serde(flatten)]
    pub(crate) base: WorkxToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct WorkxFileChangeEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: WorkxFileChangeEventParams,
}

#[derive(Serialize)]
pub(crate) struct WorkxMcpToolCallEventParams {
    #[serde(flatten)]
    pub(crate) base: WorkxToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct WorkxMcpToolCallEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: WorkxMcpToolCallEventParams,
}

#[derive(Serialize)]
pub(crate) struct WorkxDynamicToolCallEventParams {
    #[serde(flatten)]
    pub(crate) base: WorkxToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct WorkxDynamicToolCallEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: WorkxDynamicToolCallEventParams,
}

#[derive(Serialize)]
pub(crate) struct WorkxControlToolCallEventParams {
    #[serde(flatten)]
    pub(crate) base: WorkxToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct WorkxControlToolCallEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: WorkxControlToolCallEventParams,
}

#[derive(Serialize)]
pub(crate) struct WorkxCollabAgentToolCallEventParams {
    #[serde(flatten)]
    pub(crate) base: WorkxToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct WorkxCollabAgentToolCallEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: WorkxCollabAgentToolCallEventParams,
}

#[derive(Serialize)]
pub(crate) struct WorkxWebSearchEventParams {
    #[serde(flatten)]
    pub(crate) base: WorkxToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct WorkxWebSearchEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: WorkxWebSearchEventParams,
}

#[derive(Serialize)]
pub(crate) struct WorkxImageGenerationEventParams {
    #[serde(flatten)]
    pub(crate) base: WorkxToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct WorkxImageGenerationEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: WorkxImageGenerationEventParams,
}

#[derive(Serialize)]
pub(crate) struct WorkxAppMetadata {
    pub(crate) connector_id: Option<String>,
    pub(crate) thread_id: Option<String>,
    pub(crate) turn_id: Option<String>,
...
#[derive(Serialize)]
pub(crate) struct WorkxAppMentionedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: WorkxAppMetadata,
}

#[derive(Serialize)]
pub(crate) struct WorkxAppUsedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: WorkxAppMetadata,
}

#[derive(Serialize)]
pub(crate) struct WorkxHookRunMetadata {
    pub(crate) thread_id: Option<String>,
    pub(crate) turn_id: Option<String>,
    pub(crate) product_client_id: Option<String>,
    pub(crate) model_slug: Option<String>,
...
#[derive(Serialize)]
pub(crate) struct WorkxHookRunEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: WorkxHookRunMetadata,
}

#[derive(Serialize)]
pub(crate) struct WorkxCompactionEventParams {
    pub(crate) thread_id: String,
    pub(crate) session_id: String,
    pub(crate) turn_id: String,
    pub(crate) app_server_client: WorkxAppServerClientMetadata,
    ...
    pub(crate) workx_error_kind: Option<WorkxErrKind>,
    pub(crate) workx_error_http_status_code: Option<u16>,
...
#[derive(Serialize)]
pub(crate) struct WorkxCompactionEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: WorkxCompactionEventParams,
}

#[derive(Serialize)]
pub(crate) struct WorkxGoalEventParams {
    pub(crate) thread_id: String,
    pub(crate) session_id: String,
    pub(crate) turn_id: Option<String>,
    pub(crate) app_server_client: WorkxAppServerClientMetadata,
    ...
    pub(crate) goal_status: workx_state::ThreadGoalStatus,
...
#[derive(Serialize)]
pub(crate) struct WorkxGoalEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: WorkxGoalEventParams,
}

#[derive(Serialize)]
pub(crate) struct WorkxTurnEventParams {
    pub(crate) thread_id: String,
    pub(crate) session_id: String,
    pub(crate) turn_id: String,
    pub(crate) root_turn_id: Option<String>,
    pub(crate) turn_trigger: Option<String>,
    pub(crate) workx_turn_source: Option<String>,
    ...
    pub(crate) turn_error: Option<WorkxErrorInfo>,
    pub(crate) workx_error_kind: Option<WorkxErrKind>,
    pub(crate) workx_error_http_status_code: Option<u16>,
...
#[derive(Serialize)]
pub(crate) struct WorkxTurnEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: WorkxTurnEventParams,
}

#[derive(Serialize)]
pub(crate) struct WorkxTurnSteerEventParams {
    pub(crate) thread_id: String,
    pub(crate) session_id: String,
...
#[derive(Serialize)]
pub(crate) struct WorkxTurnSteerEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: WorkxTurnSteerEventParams,
}

#[derive(Serialize)]
pub(crate) struct WorkxPluginMetadata {
    pub(crate) plugin_id: Option<String>,
    pub(crate) remote_plugin_id: Option<String>,
...
#[derive(Serialize)]
pub(crate) struct WorkxPluginUsedMetadata {
    #[serde(flatten)]
    pub(crate) plugin: WorkxPluginMetadata,
...
#[derive(Serialize)]
pub(crate) struct WorkxPluginInstallRequestedPluginMetadata {
    pub(crate) plugin_id: String,
    pub(crate) remote_plugin_id: Option<String>,
...
#[derive(Serialize)]
pub(crate) struct WorkxPluginInstallRequestedMetadata {
    pub(crate) suggestion_id: String,
    pub(crate) plugins: Vec<WorkxPluginInstallRequestedPluginMetadata>,
...
#[derive(Serialize)]
pub(crate) struct WorkxPluginInstallRequestedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: WorkxPluginInstallRequestedMetadata,
}

#[derive(Serialize)]
pub(crate) struct WorkxPluginEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: WorkxPluginMetadata,
}

#[derive(Serialize)]
pub(crate) struct WorkxPluginInstallFailedMetadata {
    #[serde(flatten)]
    pub(crate) plugin: WorkxPluginMetadata,
...
#[derive(Serialize)]
pub(crate) struct WorkxPluginInstallFailedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: WorkxPluginInstallFailedMetadata,
}

#[derive(Serialize)]
pub(crate) struct WorkxOnboardingExternalAgentImportCompleteMetadata {
...
#[derive(Serialize)]
pub(crate) struct WorkxOnboardingExternalAgentImportCompleteEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: WorkxOnboardingExternalAgentImportCompleteMetadata,
}

#[derive(Serialize)]
pub(crate) struct WorkxOnboardingExternalAgentImportFailureMetadata {
    pub(crate) import_id: String,
    pub(crate) source: String,
    pub(crate) provider_id: String,
    #[serde(rename = "type")]
...
#[derive(Serialize)]
pub(crate) struct WorkxOnboardingExternalAgentImportFailureEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: WorkxOnboardingExternalAgentImportFailureMetadata,
}

#[derive(Serialize)]
pub(crate) struct WorkxPluginUsedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: WorkxPluginUsedMetadata,
}

pub(crate) fn plugin_state_event_type(state: PluginState) -> &'static str {
    match state {
        PluginState::Installed => "workx_plugin_installed",
        PluginState::Uninstalled => "workx_plugin_uninstalled",
        PluginState::Enabled => "workx_plugin_enabled",
        PluginState::Disabled => "workx_plugin_disabled",
    }
}

pub(crate) fn workx_app_metadata(
    tracking: &TrackEventsContext,
    app: AppInvocation,
) -> WorkxAppMetadata {
    WorkxAppMetadata {
...
pub(crate) fn workx_plugin_metadata(plugin: PluginTelemetryMetadata) -> WorkxPluginMetadata {
    workx_plugin_metadata_with_product_client_id(plugin, originator().value)
}

fn workx_plugin_metadata_with_product_client_id(
...
pub(crate) fn workx_plugin_install_requested_metadata(
    tracking: &TrackEventsContext,
    request: PluginInstallRequested,
) -> WorkxPluginInstallRequestedMetadata {
    WorkxPluginInstallRequestedMetadata {
        suggestion_id: request.suggestion_id,
        plugins: request
            .plugins
            .into_iter()
            .map(|plugin| WorkxPluginInstallRequestedPluginMetadata {
...
pub(crate) fn workx_compaction_event_params(
    input: WorkxCompactionEvent,
    session_id: String,
    ...
    WorkxCompactionEventParams {
        ...
        status: input.status,
        workx_error_kind: input.workx_error_kind,
        workx_error_http_status_code: input.workx_error_http_status_code,
...
pub(crate) fn workx_goal_event_params(
    input: WorkxGoalEvent,
    session_id: String,
    app_server_client: WorkxAppServerClientMetadata,
    runtime: WorkxRuntimeMetadata,
    thread_source: Option<ThreadSource>,
...
pub(crate) fn workx_plugin_used_metadata(
    tracking: &TrackEventsContext,
    plugin: PluginTelemetryMetadata,
) -> WorkxPluginUsedMetadata {
    let mcp_server_names = plugin
        .capability_summary
        .as_ref()
        .map(|summary| summary.mcp_server_names.clone());
    WorkxPluginUsedMetadata {
        plugin: workx_plugin_metadata_with_product_client_id(
            plugin,
...
pub(crate) fn workx_hook_run_metadata(
    tracking: &TrackEventsContext,
    hook: HookRunFact,
) -> WorkxHookRunMetadata {
    WorkxHookRunMetadata {
        thread_id: Some(tracking.thread_id.clone()),
        turn_id: Some(tracking.turn_id.clone()),
        product_client_id: Some(tracking.product_client_id.clone()),
...
pub(crate) fn current_runtime_metadata() -> WorkxRuntimeMetadata {
    let os_info = os_info::get();
    WorkxRuntimeMetadata {
        workx_rs_version: env!("CARGO_PKG_VERSION").to_string(),

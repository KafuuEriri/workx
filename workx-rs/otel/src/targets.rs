pub(crate) const OTEL_TARGET_PREFIX: &str = "workx_otel";
pub(crate) const OTEL_LOG_ONLY_TARGET: &str = "workx_otel.log_only";
pub(crate) const OTEL_TRACE_SAFE_TARGET: &str = "workx_otel.trace_safe";

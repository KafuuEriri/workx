...
use workx_app_server_protocol::RemoteControlDisableParams;
use workx_app_server_protocol::RemoteControlDisableResponse;
use workx_app_server_protocol::RemoteControlEnableParams;
...
async fn connect_with_retry(
    ...
    connect_timeout: Duration,
    connect_retry_delay: Duration,
) -> Result<WebSocketStream<workx_uds::UnixStream>> {
...
mod tests {
    ...
    const TEST_WORKX_HOME: &str = "/tmp/workx-home";
        ...
        client::send_message(
            ...
            &JSONRPCMessage::Response(JSONRPCResponse {
                ...
                result: serde_json::json!({
                    "userAgent": "workx_app_server/1.2.3",
                    "workxHome": TEST_WORKX_HOME,
                    "platformFamily": "unix",
                    "platformOs": "macos",
                }),
            }),

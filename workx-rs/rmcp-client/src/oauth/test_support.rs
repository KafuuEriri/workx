...
/// Serializes tests that mutate process-wide WORKX_HOME.
///
...
pub(crate) struct TempWorkxHome {
...
impl TempWorkxHome {
    pub(crate) fn new() -> Self {
        ...
        let dir = tempdir().expect("create WORKX_HOME temp dir");
        unsafe {
            std::env::set_var("WORKX_HOME", dir.path());
        }
        Self {
            _guard: guard,
            _dir: dir,

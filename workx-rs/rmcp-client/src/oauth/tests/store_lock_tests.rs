...
use crate::oauth::test_support::TempWorkxHome;
use workx_config::types::OAuthCredentialsStoreMode;

const STORE_LOCK_CONTENTION_EVENT_TARGET: &str = "workx_rmcp_client::oauth::store_lock::contention";
...
fn file_credentials_keep_repeated_local_prefixes_isolated() -> Result<()> {
    ...
    let config: workx_config::McpServerConfig = serde_json::from_value(serde_json::json!({
...
const LOCK_HOLDER_READY_PATH_ENV: &str = "WORKX_OAUTH_STORE_LOCK_CHILD_READY_PATH";

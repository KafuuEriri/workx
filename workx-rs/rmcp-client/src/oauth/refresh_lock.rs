...
const LOCK_CONTENTION_EVENT_TARGET: &str = "workx_rmcp_client::oauth::refresh_lock::contention";
...
impl RefreshCredentialLock {
    pub(crate) async fn acquire_for_server(server_name: &str, url: &str) -> Result<Self> {
        ...
        Self::acquire_in(&workx_home, &store_key, REFRESH_LOCK_ACQUIRE_TIMEOUT)
            .await
    ...
    async fn acquire_in(
        ...
        // Scope coordination to WORKX_HOME alongside File and Secrets state. Direct keyring

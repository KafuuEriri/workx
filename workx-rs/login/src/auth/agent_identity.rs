...
use workx_agent_identity::agent_identity_jwks_url;
use workx_agent_identity::agent_registration_url;
use workx_agent_identity::agent_task_registration_url;
use workx_agent_identity::build_abom;
use workx_agent_identity::decode_agent_identity_jwt;
use workx_agent_identity::fetch_agent_identity_jwks;
use workx_agent_identity::generate_agent_key_material;
use workx_agent_identity::is_retryable_registration_error;
use workx_agent_identity::public_key_ssh_from_private_key_pkcs8_base64;
use workx_agent_identity::register_agent_identity;
use workx_agent_identity::register_agent_task;
...
const WORKX_AGENT_IDENTITY_AUTHAPI_BASE_URL_ENV_VAR: &str = "WORKX_AGENT_IDENTITY_AUTHAPI_BASE_URL";
const WORKX_AGENT_IDENTITY_JWKS_BASE_URL_ENV_VAR: &str = "WORKX_AGENT_IDENTITY_JWKS_BASE_URL";
...
pub(super) fn agent_identity_authapi_base_url(
    ...
    let authapi_base_url =
        agent_identity_endpoint_override(WORKX_AGENT_IDENTITY_AUTHAPI_BASE_URL_ENV_VAR);
    let jwks_base_url =
        agent_identity_endpoint_override(WORKX_AGENT_IDENTITY_JWKS_BASE_URL_ENV_VAR);
...
pub(super) async fn verified_record_from_jwt(
    ...
    let jwks_base_url =
        match agent_identity_endpoint_override(WORKX_AGENT_IDENTITY_JWKS_BASE_URL_ENV_VAR) {
            Some(base_url) => {

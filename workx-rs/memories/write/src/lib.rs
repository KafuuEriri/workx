//! Write-path implementation for Workx memories.
//!
...
mod guard_limits {
    pub(super) const WORKX_LIMIT_ID: &str = "workx";
}
...
mod stage_one {
    pub(super) const REASONING_EFFORT: workx_protocol::openai_models::ReasoningEffort =
        workx_protocol::openai_models::ReasoningEffort::Low;
...
mod stage_two {
    pub(super) const REASONING_EFFORT: workx_protocol::openai_models::ReasoningEffort =
        workx_protocol::openai_models::ReasoningEffort::Medium;
    pub(super) const JOB_LEASE_SECONDS: i64 = 3_600;
    pub(super) const JOB_RETRY_DELAY_SECONDS: i64 = 3_600;

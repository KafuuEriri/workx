...
use workx_core::context::GuardianReviewEvidence;
...
use workx_extension_api::ThreadOriginator;
...
use workx_login::AgentIdentityAuthPolicy;
...
use workx_protocol::mcp::is_node_repl_backed_tool;
...
use workx_protocol::protocol::has_full_access;
    ...
    async fn score_tool(&self, input: ToolStartInput<'_>) {
        ...
        tokio::spawn(async move {
            ...
            classification_input.extend([
                "The Workx agent has requested the following action:\n".to_owned(),

...
pub(super) const CLASSIFICATION_METRIC: &str = "workx.guardian_v2.classification";
pub(super) const CLASSIFICATION_DURATION_METRIC: &str =
    "workx.guardian_v2.classification.duration_ms";
pub(super) const CLASSIFICATION_RISK_METRIC: &str = "workx.guardian_v2.classification.risk";
pub(super) const FAST_DECISION_METRIC: &str = "workx.guardian_v2.fast_decision";
pub(super) const REVIEW_FALLBACK_METRIC: &str = "workx.guardian_v2.review_fallback";
pub(super) const TOOL_CALL_LAG_METRIC: &str = "workx.guardian_v2.tool_call_lag";

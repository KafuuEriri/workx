...
#[tokio::test]
async fn routes_through_workx_backend_and_injects_trusted_session_agent_context() {
...
async fn marks_encrypted_history_and_notes_arguments_without_changing_the_json_body() {
    ...
    let auth_manager =
        AuthManager::from_auth_for_testing(WorkxAuth::Headers(AuthHeaders::new(HeaderMap::new())));

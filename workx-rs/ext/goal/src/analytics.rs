...
use workx_analytics::GoalEventKind;
use workx_analytics::WorkxGoalEvent;
...
impl GoalAnalytics {
    ...
    pub(crate) fn cleared(&self, goal: &workx_state::ThreadGoal) {
    ...
    fn track(
        ...
        self.client.track_goal_event(WorkxGoalEvent {

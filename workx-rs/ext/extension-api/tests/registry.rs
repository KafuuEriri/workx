...
use serde_json::json;
use workx_extension_api::ApprovalAssessment;
use workx_extension_api::ApprovalReviewContributor;
use workx_extension_api::ApprovalReviewError;
use workx_extension_api::ApprovalReviewInput;
use workx_extension_api::ConfigContributor;
use workx_extension_api::ContentItemKind;
use workx_extension_api::ContextContributor;
use workx_extension_api::ContextualUserFragment;
...
use workx_extension_api::PromptFragment;
...
use workx_extension_api::TokenUsageContributor;
...
use workx_extension_api::TurnInputContributor;
use workx_extension_api::TurnItemContributor;
use workx_extension_api::TurnLifecycleContributor;
use workx_extension_api::empty_extension_registry;
use workx_protocol::ThreadId;
use workx_protocol::approvals::GuardianAssessmentOutcome;
use workx_protocol::approvals::GuardianRiskLevel;
use workx_protocol::approvals::GuardianUserAuthorization;
use workx_protocol::items::HookPromptItem;
        ...
        fragments.extend(
            contributor
                .contribute_turn_context(TurnContextContributionInput {
                    thread_id: workx_protocol::ThreadId::default(),

...
use workx_thread_store::MAX_QUEUE_ITEMS;
use workx_thread_store::QueueStore;
use workx_thread_store::QueuedUserSubmissionRecord;
...
pub enum QueueServiceError {
    ...
    CoreSubmissionError(#[from] WorkxErr),

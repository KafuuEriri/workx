...
use workx_analytics::SkillInvocation;
use workx_analytics::SkillInvocationLocation;
...
impl SkillToolAuthority {
    ...
    pub(crate) fn from_authority(authority: &SkillAuthority) -> Option<Self> {
        match &authority.kind {
            SkillSourceKind::Orchestrator if authority.id == WORKX_APPS_MCP_SERVER_NAME => {

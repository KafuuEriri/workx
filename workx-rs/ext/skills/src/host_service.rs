...
use workx_config::bundled_skills_enabled_from_stack;
...
use workx_skills::install_system_skills;
...
impl HostSkillsService {
    pub fn new(workx_home: AbsolutePathBuf, bundled_skills_enabled: bool) -> Self {
        Self::new_with_restriction_product(workx_home, bundled_skills_enabled, Some(Product::Workx))
    }
    ...
    pub fn new_with_restriction_product(
        ...
        // The cache is shared by every process using this WORKX_HOME. Disabled services filter
    ...
    fn ensure_system_skills_installed(&self) {
        if let Err(err) = install_system_skills(&self.workx_home) {

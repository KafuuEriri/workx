...
use workx_mcp::McpEventNotification;
...
impl Fixture {
    pub async fn new() -> Result<Self> {
        ...
        let auth_value = WorkxAuth::from_external_chatgpt_tokens(
            "header.e30.first",
            "account",
        ...
        let mut server_config = workx_mcp::hosted_plugin_runtime_mcp_server_config(
        ...
        *bearer_token_env_var = None;
        ...
        let runtime_input = || McpRuntimeInput {
            ...
            mcp_servers: HashMap::from([(
                WORKX_APPS_MCP_SERVER_NAME.into(),
            ...
            workx_apps_tools_cache: Default::default(),
            tool_catalog_cache: Default::default(),
            workx_apps_tools_cache_key: workx_mcp::workx_apps_tools_cache_key(Some(&auth_value)),
        ...
        assert!(
            runtime
                .latest_wait_for_server_ready(WORKX_APPS_MCP_SERVER_NAME, WAIT)
                .await
        );
        Ok(Self {
            _home: home,
...
pub(super) struct StaticAuth(pub WorkxAuth);

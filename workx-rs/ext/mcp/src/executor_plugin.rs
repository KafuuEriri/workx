...
use workx_connectors_extension::ExecutorPluginConnectorProvider;
use workx_core::config::Config;
use workx_core_plugins::ExecutorPluginProvider;
use workx_core_plugins::loader::apply_configured_plugin_mcp_server_policies;
use workx_core_plugins::loader::configured_plugin_mcp_server_policies;
...
struct SelectedPluginMetadata {
    ...
    servers: Vec<(String, workx_config::McpServerConfig)>,

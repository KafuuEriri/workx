...
use workx_code_mode_protocol::CodeModeSession;
use workx_code_mode_protocol::CodeModeSessionCellExecutionLimits;
use workx_code_mode_protocol::CodeModeSessionDelegate;
use workx_code_mode_protocol::CodeModeSessionResultFuture;
use workx_code_mode_protocol::CodeModeToolKind;
use workx_code_mode_protocol::DEFAULT_EXEC_YIELD_TIME_MS;
use workx_code_mode_protocol::ExecuteRequest;
use workx_code_mode_protocol::ExecuteToPendingOutcome;
use workx_code_mode_protocol::FunctionCallOutputContentItem;
use workx_code_mode_protocol::ImageDetail;
use workx_code_mode_protocol::NoopCodeModeSessionDelegate;
use workx_code_mode_protocol::RuntimeResponse;
use workx_code_mode_protocol::StartedCell;
use workx_code_mode_protocol::WaitOutcome;
use workx_code_mode_protocol::WaitRequest;
use workx_code_mode_protocol::WaitToPendingOutcome;
use workx_code_mode_protocol::WaitToPendingRequest;
        ...
        self.delegate
            .invoke_tool(
                CodeModeNestedToolCall {
                    ...
                    tool_name: workx_protocol::ToolName {

...
def build_plugin_json(
    ...
    payload: dict[str, Any] = {
        ...
        "interface": {
            ...
            "shortDescription": f"Use {display_name} in Workx.",
            "longDescription": f"{display_name} adds a local Workx plugin scaffold.",
...
def main() -> None:
    ...
    plugin_json_path = plugin_root / ".workx-plugin" / "plugin.json"
    write_json(
        plugin_json_path,
        build_plugin_json(

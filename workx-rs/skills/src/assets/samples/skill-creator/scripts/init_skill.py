...
[TODO: Add the task-specific guidance Workx needs. Reference supporting files only when they are relevant.]
"""
...
Replace this placeholder with maintained, task-specific details that Workx

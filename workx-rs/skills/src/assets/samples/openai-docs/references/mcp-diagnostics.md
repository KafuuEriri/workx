...
3. When the current documentation supports it, the local Workx CLI setup is:

   ```sh
   workx mcp add openaiDeveloperDocs --url https://developers.openai.com/mcp
   ```

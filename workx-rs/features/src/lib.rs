...
pub enum Feature {
    ...
    /// Requires every reader of the Workx home to support compressed shared histories.
    ...
    Chronicle,
    /// Compress request bodies (zstd) when sending streaming requests to workx-backend.
    ...
    NetworkProxy,
    /// Respect host system proxy settings for Workx-owned network clients.
    RespectSystemProxy,
    /// Enable collab tools.
    Collab,
    ...
    /// Prompt Workx Apps connector auth failures through MCP URL elicitations.
    AuthElicitation,
...
pub const FEATURES: &[FeatureSpec] = &[
    ...
    FeatureSpec {
        id: Feature::WorkxGitCommit,
        key: "workx_git_commit",
        stage: Stage::Removed,
        default_enabled: false,
    },
    FeatureSpec {
    ...
    FeatureSpec {
        ...
        stage: Stage::Experimental {
            ...
            announcement: "NEW: Network proxy can now be enabled from /experimental. Restart Workx after enabling it.",
        },
        default_enabled: false,
    },
    FeatureSpec {
    ...
    FeatureSpec {
        ...
        stage: if cfg!(any(
            ...
            Stage::Experimental {
                ...
                menu_description: "Keep your computer awake while Workx is running a thread.",

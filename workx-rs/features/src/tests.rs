...
"#,
    ...
    assert_eq!(
        ...
        Some(FeatureToml::Config(crate::GuardianV2ConfigToml {
            ...
            reasoning_effort: Some(workx_protocol::openai_models::ReasoningEffort::Minimal),
...
#[test]
fn workx_hooks_is_legacy_alias_for_hooks() {
    assert_eq!(feature_for_key("hooks"), Some(Feature::WorkxHooks));
    assert_eq!(feature_for_key("workx_hooks"), Some(Feature::WorkxHooks));
}

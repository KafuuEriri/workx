...
/// One Workx thread/session participating in the rollout.
///
...
/// Provenance for a traced Workx thread.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
...
/// One activation of the Workx runtime for one thread.
///
/// A Workx turn groups protocol/runtime work for one thread activation.
/// It is not a user/assistant message pair; conversation belongs in
/// `ConversationItem`.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct WorkxTurn {

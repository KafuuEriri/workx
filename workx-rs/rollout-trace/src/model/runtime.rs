...
/// Runtime operation requested by the model, a JS code cell, or Workx itself.
///
...
pub struct ToolCall {
    ...
    pub started_by_workx_turn_id: Option<WorkxTurnId>,
    pub execution: ExecutionWindow,
    ...
    /// Original invocation at the Workx tool boundary.
    ///
    ...
    /// they describe how Workx executed the request, not what the caller sent.

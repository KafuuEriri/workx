...
/// Workx conversation/session UUID.
...
/// Process/session ID returned by Workx's terminal runtime.
...
/// Canonical reduced graph for one Workx rollout.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct RolloutTrace {
    pub schema_version: u32,
    /// Unique identity for this trace capture.
    ///
    /// `rollout_id` names the Workx rollout/session being observed. `trace_id`
    ...
    pub workx_turns: BTreeMap<WorkxTurnId, WorkxTurn>,

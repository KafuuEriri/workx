        ...
        match event.payload {
            ...
            RawTraceEventPayload::CodeCellStarted {
                ...
                self.start_or_queue_code_cell(PendingCodeCellStart {
                    ...
                    thread_id,
                    workx_turn_id: event.workx_turn_id,
            ...
            RawTraceEventPayload::CompactionInstalled {
                ...
                let Some(workx_turn_id) = event.workx_turn_id else {
                    bail!(
                        "compaction installed event {compaction_id} did not include a workx turn id"
                    );
                };

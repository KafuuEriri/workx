...
use workx_protocol::protocol::CollabAgentInteractionBeginEvent;
use workx_protocol::protocol::CollabAgentInteractionEndEvent;
use workx_protocol::protocol::CollabAgentSpawnEndEvent;
use workx_protocol::protocol::CollabCloseBeginEvent;
use workx_protocol::protocol::CollabCloseEndEvent;
...
pub(in crate::reducer) struct ObservedAgentResultEdge {
    ...
    pub(in crate::reducer) child_workx_turn_id: String,
        ...
        self.rollout
            ...
            .filter(|item| {
                item.thread_id == thread_id
                    && item.workx_turn_id.as_deref() == Some(workx_turn_id)

...
pub struct RawTraceEvent {
    ...
    pub workx_turn_id: Option<WorkxTurnId>,
...
pub enum RawTraceEventPayload {
    ...
    InferenceCancelled {
        ...
        /// before Workx stopped consuming the stream.
        upstream_request_id: Option<String>,
        /// Why Workx stopped consuming the provider stream before a terminal response event.
        reason: String,
    ...
    ToolCallRuntimeStarted {
        tool_call_id: ToolCallId,
        /// Runtime/protocol observation for how Workx began executing the tool.
        runtime_payload: RawPayloadRef,
    },
    ToolCallRuntimeEnded {
        tool_call_id: ToolCallId,
        status: ExecutionStatus,
        /// Runtime/protocol observation for how Workx finished executing the tool.
        runtime_payload: RawPayloadRef,
    },
    ToolCallEnded {
        tool_call_id: ToolCallId,
    ...
    AgentResultObserved {
        ...
        child_workx_turn_id: WorkxTurnId,
...
impl RawTraceEventPayload {
    ...
    pub(crate) fn raw_payload_refs(&self) -> Vec<&RawPayloadRef> {
        match self {
            ...
            | RawTraceEventPayload::WorkxTurnEnded { .. }

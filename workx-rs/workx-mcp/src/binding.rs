...
impl PreparedMcpCall {
    ...
    /// Returns whether this call is bound to the host-owned Workx Apps server.
    ...
    /// this call's exact catalog revision and the extensions owned by the Workx session.

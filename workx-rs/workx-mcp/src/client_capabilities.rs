...
use workx_protocol::mcp::OPENAI_ELICITATION_EXTENSION_ID;
use workx_protocol::mcp::OPENAI_FORM_EXTENSION_ID;
use workx_protocol::mcp::OPENAI_STANDARD_FORM_INPUT_EXTENSION_ID;

/// Selects the MCP extensions Workx supports from those declared by the app-server host.
///
/// App-server clients may declare unrelated extensions. Workx retains only the

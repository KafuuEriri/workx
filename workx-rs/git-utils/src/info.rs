...
/// directory. If you need Workx to work from such a checkout simply pass the
...
mod tests {
    ...
    async fn git_metadata_commands_do_not_inherit_stdin() {
        const CHILD_ENV: &str = "WORKX_GIT_UTILS_STDIN_CHILD";
    ...
    fn canonicalize_git_remote_url_normalizes_github_variants() {
        for remote in [
            "git@github.com:OpenAI/Workx.git",
            "ssh://git@github.com/RonanXiao/workx.git",
            "ssh://git@github.com:22/OpenAI/Workx.git",
            "https://github.com/RonanXiao/workx.git",
            "https://github.com:443/RonanXiao/workx.git",
            "https://token@github.com/RonanXiao/workx/",
            "github.com/OpenAI/Workx.git",
        ] {
            assert_eq!(
                canonicalize_git_remote_url(remote),
                Some("github.com/RonanXiao/workx".to_string())
            );
        }
    }

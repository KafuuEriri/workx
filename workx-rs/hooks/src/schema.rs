...
pub(crate) struct PreToolUseCommandInput {
    ...
    /// Workx extension: expose the active turn id to internal turn-scoped hooks.
    pub turn_id: String,
...
mod tests {
    ...
    #[test]
    fn turn_scoped_hook_inputs_include_workx_turn_id_extension() {
        // Workx intentionally diverges from Claude's public hook docs here so

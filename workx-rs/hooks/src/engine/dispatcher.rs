...
pub(crate) fn completed_summary(
    ...
    entries: Vec<workx_protocol::protocol::HookOutputEntry>,
) -> HookRunSummary {
    let HandlerSourcePath::Local(source_path) = &handler.source_path else {
        unreachable!("executor-scoped hooks do not produce public hook summaries");
    };
...
pub(crate) fn hook_source_label(source: workx_protocol::protocol::HookSource) -> &'static str {
    match source {
        workx_protocol::protocol::HookSource::System => "system",
        workx_protocol::protocol::HookSource::User => "user",
        workx_protocol::protocol::HookSource::Project => "project",
        workx_protocol::protocol::HookSource::Mdm => "mdm",
        workx_protocol::protocol::HookSource::SessionFlags => "session_flags",
        workx_protocol::protocol::HookSource::Plugin => "plugin",
        workx_protocol::protocol::HookSource::CloudRequirements => "cloud_requirements",
        workx_protocol::protocol::HookSource::CloudManagedConfig => "cloud_managed_config",
        workx_protocol::protocol::HookSource::LegacyManagedConfigFile => {
            "legacy_managed_config_file"
        }
        workx_protocol::protocol::HookSource::LegacyManagedConfigMdm => "legacy_managed_config_mdm",
        workx_protocol::protocol::HookSource::Unknown => "unknown",
    }
}

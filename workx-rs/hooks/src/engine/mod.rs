...
pub(crate) struct ConfiguredHandler {
    ...
    pub builtin: bool,
    pub event_name: workx_protocol::protocol::HookEventName,
...
impl ConfiguredHandler {
    ...
    fn event_name_label(&self) -> &'static str {
        match self.event_name {
            workx_protocol::protocol::HookEventName::PreToolUse => "pre-tool-use",
            workx_protocol::protocol::HookEventName::PermissionRequest => "permission-request",
            workx_protocol::protocol::HookEventName::PostToolUse => "post-tool-use",
            workx_protocol::protocol::HookEventName::PreCompact => "pre-compact",
            workx_protocol::protocol::HookEventName::PostCompact => "post-compact",
            workx_protocol::protocol::HookEventName::SessionStart => "session-start",
            workx_protocol::protocol::HookEventName::SessionEnd => "session-end",
            workx_protocol::protocol::HookEventName::UserPromptSubmit => "user-prompt-submit",
            workx_protocol::protocol::HookEventName::SubagentStart => "subagent-start",
            workx_protocol::protocol::HookEventName::SubagentStop => "subagent-stop",
            workx_protocol::protocol::HookEventName::Stop => "stop",
            workx_protocol::protocol::HookEventName::Interrupt => "interrupt",
        }
    }

...
impl Hooks {
    ...
    ) -> anyhow::Result<(Self, Receiver<workx_protocol::protocol::HookCompletedEvent>)> {
    ...
    ) -> Vec<workx_protocol::protocol::HookRunSummary> {
    ...
    pub fn preview_session_end(&self) -> Vec<workx_protocol::protocol::HookRunSummary> {
    ...
    pub fn preview_interrupt(&self) -> Vec<workx_protocol::protocol::HookRunSummary> {

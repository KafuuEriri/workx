...
pub type LoadedPlugin = workx_plugin::LoadedPlugin<workx_config::McpServerConfig>;
pub type PluginLoadOutcome = workx_plugin::PluginLoadOutcome<workx_config::McpServerConfig>;

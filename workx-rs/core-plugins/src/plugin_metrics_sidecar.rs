...
use uuid::Uuid;
use workx_analytics::PluginMeasurementRow;
...
pub const PLUGIN_METRICS_OUTPUT_ENV_VAR: &str = "WORKX_PLUGIN_METRICS_OUTPUT";
...
impl PluginMetricsSidecar {
    ...
    pub async fn create_remote(
        ...
        let directory_path = temp_dir
            .join(&format!("workx-plugin-metrics-{execution_id}"))
            .ok()?;

...
//! preserve the legacy `workx_login::default_client::create_client_without_request_logging()`
...
//! startup-sync request helpers remain responsible for applying the standard Workx headers.
...
use workx_http_client::RequestBuilder;

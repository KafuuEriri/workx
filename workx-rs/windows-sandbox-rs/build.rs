...
const SETUP_BIN: &str = "workx-windows-sandbox-setup";
const SETUP_MANIFEST: &str = "workx-windows-sandbox-setup.manifest";
...
fn main() -> Result<(), String> {
    ...
    // Keep this scoped to the setup helper so Workx binaries that link the

...
const SESSION_NAME: &str = "Workx Windows Sandbox WFP";
const PROVIDER_NAME: &str = "Workx Windows Sandbox WFP";
const PROVIDER_DESCRIPTION: &str = "Persistent WFP provider for Workx Windows sandbox filters";
const SUBLAYER_NAME: &str = "Workx Windows Sandbox WFP";
const SUBLAYER_DESCRIPTION: &str = "Persistent WFP sublayer for Workx Windows sandbox filters";

// WFP identifies persistent providers, sublayers, and filters by stable GUIDs.
// These values are Workx-owned identities; do not regenerate them unless we
...
/// Installs the persistent Workx WFP filters for `account`.
///
...
/// Ensures the persistent Workx WFP provider exists.
...
/// Ensures the persistent Workx sublayer exists under the Workx provider.

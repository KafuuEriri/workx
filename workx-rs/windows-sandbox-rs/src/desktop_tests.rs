...
fn private_desktop_rejects_interactive_and_injected_names() {
    for name in [
        ...
        r"Winsta0\Default",
        "WorkxSandboxDesktop-",
        r"WorkxSandboxDesktop-abcd\Default",
        "WorkxSandboxDesktop-abcd\0Default",
        "WorkxSandboxDesktop-0123456789abcdef0123456789abcdef0",
    ] {
...
fn legacy_desktop_reuses_only_equivalent_permissions() -> Result<()> {
    ...
    let security = prepare_legacy_session_security(
        ...
        &workx_home,
        &workspace,
        legacy_session_capability_roots(&permissions, &workspace, &env, &workx_home),
    )?;

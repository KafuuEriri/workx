...
fn runtime_paths_include_desktop_parent_and_primary_runtime_roots() {
    ...
    assert_eq!(
        ...
        vec![
            PathBuf::from(r"C:\Users\user\AppData\Local\OpenAI\Workx"),
            PathBuf::from(r"C:\Users\user\.cache\workx-runtimes"),
        ]
    );
}
...
fn primary_runtime_path_does_not_depend_on_local_app_data() {
    ...
    assert_eq!(
        ...
        vec![PathBuf::from(r"C:\Users\user\.cache\workx-runtimes")]
    );
}

...
pub(super) const FILTER_SPECS: &[FilterSpec] = &[
    FilterSpec {
        ...
        name: "workx_wfp_icmp_connect_v4",
    ...
    FilterSpec {
        ...
        name: "workx_wfp_icmp_connect_v6",

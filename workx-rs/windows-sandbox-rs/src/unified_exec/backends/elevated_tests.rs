...
fn retry_uses_original_unified_exec_request_and_stops_after_second_failure() {
    ...
    let request = RunnerTransportRequest {
        ...
        workx_home: PathBuf::from(r"C:\Users\workx"),
        cwd: PathBuf::from(r"C:\workspace"),
        env_map: env_map.clone(),
        logs_base_dir: Some(PathBuf::from(r"C:\Users\workx\.sandbox")),
        spawn_request: SpawnRequest {
            ...
            workx_home: PathBuf::from(r"C:\Users\workx\.sandbox"),
            real_workx_home: PathBuf::from(r"C:\Users\workx"),
        ...
        deny_write_paths_override: vec![PathBuf::from(r"C:\workspace\.workx")],
        proxy_enforced: true,
    ...
    let expected_refresh = RefreshObservation {
        ...
        env_map,
        workx_home: request.workx_home.clone(),
    ...
    let result = spawn_runner_transport_with_retry(
        ...
        &request,
        |workx_home, cwd, sandbox_creds, logs_base_dir, spawn_request| {

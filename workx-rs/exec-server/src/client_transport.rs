...
const ENVIRONMENT_CLIENT_NAME: &str = "workx-environment";
...
impl ExecServerClient {
    ...
    #[tracing::instrument(name = "workx.exec_server.remote.noise.connect", skip_all)]
    ...
    #[tracing::instrument(
        name = "workx.exec_server.remote.harness.connect",
        skip_all,
        fields(
            otel.kind = "client",
            otel.name = "workx.exec_server.remote.harness.connect",
        )
    )]
    ...
    #[tracing::instrument(
        name = "workx.exec_server.remote.noise.websocket_connect",
        skip_all,
        fields(
            otel.kind = "client",
            otel.name = "workx.exec_server.remote.noise.websocket_connect",

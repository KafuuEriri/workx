...
use workx_shell_command::shell_detect::ShellType;
use workx_shell_command::shell_snapshot::snapshot_state_and_environment_script;
...
impl ShellSnapshotCache {
    pub(crate) async fn prepare(
        ...
        while !state.is_empty() {
            ...
            let name = format!("__WORKX_SHELL_SNAPSHOT_STATE_{}", state_variables.len());

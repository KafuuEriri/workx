...
async fn sandbox_request_wraps_native_argv_on_executor() {
    ...
    #[cfg(target_os = "linux")]
    {
        assert_eq!(
            ...
            Some(&runtime_paths.workx_self_exe.to_string_lossy().into_owned())
        );
...
async fn sandbox_request_routes_custom_arg0_to_inner_helper() {
    ...
    #[cfg(target_os = "linux")]
    assert_eq!(prepared.arg0, Some(WORKX_LINUX_SANDBOX_ARG0.to_string()));
    #[cfg(target_os = "macos")]

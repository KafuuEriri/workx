...
fn default_search_text_uses_model_visible_namespace_metadata_once() {
    ...
    let spec = ToolSpec::Namespace(crate::ResponsesApiNamespace {
        ...
        description: "Manage Workx automations.".to_string(),
        tools: vec![ResponsesApiNamespaceTool::Function(ResponsesApiTool {
    ...
    assert_eq!(
        ...
        "workx_app Manage Workx automations. automation_update automation update Create or update automations. Automation options. mode Update mode. schedule Schedule settings. timezone IANA timezone."
    );
}

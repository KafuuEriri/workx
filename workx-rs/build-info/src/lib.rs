//! Resolve the release identity of the current Workx runtime.
...
impl BuildInfo {
    /// Return build information for the current Workx runtime.
    pub fn get() -> Self {
        BUILD_INFO
    ...
    /// Format the version for a user-facing Workx header.

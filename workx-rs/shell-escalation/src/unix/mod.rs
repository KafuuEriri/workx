...
//! `EscalateRequest` over the inherited `WORKX_ESCALATE_SOCKET`, and the server decides whether to
...
//! specified by the `WORKX_ESCALATE_SOCKET` environment variable to _send_ escalation requests,
...
pub use workx_protocol::approvals::EscalationPermissions;
pub use workx_protocol::approvals::ResolvedPermissionProfile;
